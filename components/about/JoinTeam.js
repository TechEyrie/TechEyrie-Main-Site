...
const JoinTeam = ({ theme = "light" }) => {
  ...
  return (
    <section className={`relative py-32 md:py-48 overflow-hidden border-b transition-colors duration-500 ${isDark ? 'bg-[#162d24] text-[#f3f3f3] border-[#e0d1b6]/12' : 'bg-white text-black border-gray-100'}`}>
        ...
        <svg className="w-full h-full" viewBox="0 0 1440 800" fill="none" preserveAspectRatio="none">
          ...
          <defs>
            ...
            <linearGradient id="gradient2" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#67bfda" stopOpacity="0" />
              <stop offset="50%" stopColor="#12685b" />
              <stop offset="100%" stopColor="#67bfda" stopOpacity="0" />
            </linearGradient>
          </defs>
        </svg>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 text-center">
        ...
        <div className="max-w-2xl mx-auto">
          <MaskedReveal delay={0.2}>
            <Link 
              href="#" 
              className={`about-lux-link inline-block font-merriweather text-[14px] font-semibold tracking-[0.16em] uppercase border-b pb-1 transition-colors ${
                  isDark 
                  ? 'border-[#e8e4dc]/45' 
