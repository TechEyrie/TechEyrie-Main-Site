          ...
          <div className="space-y-8 md:space-y-12">
            <MaskedReveal delay={0.1}>
              <p className={`font-merriweather text-[14px] leading-relaxed ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                Every day, billions <strong className={`font-semibold ${isDark ? 'text-white' : 'text-black'}`}>billions of business takes place through a chain</strong>, yet inefficiency remains the same, outdated processes, spreadsheets and clipboards, resulting in obstructions and inefficiency which luxury clients reject.
