                      ...
                      <div className="card-inner-content relative w-full h-full overflow-hidden rounded-xl">
                        ...
                        >
                          ...
                          <div className="absolute bottom-2 sm:bottom-3 left-0 right-0 flex flex-col items-center">
                            <h3 className="text-[#013825] font-medium text-[9px] sm:text-[10px] mb-0.5">{asset.title}</h3>
                            <p className="text-[#013825] text-[8px] sm:text-[9px] font-medium">{asset.metric}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="card-inner-content relative w-full h-full overflow-hidden rounded-xl">
                        ...
                        >
                          ...
                          <div className="absolute bottom-2 left-0 right-0 flex flex-col items-center">
                            <h3 className="text-[#013825] font-medium text-[8px] mb-0.5">{asset.title}</h3>
                            <p className="text-[#013825] text-[7px] font-medium">{asset.metric}</p>
                          </div>
                        </div>
                      </div>
                    </div>
