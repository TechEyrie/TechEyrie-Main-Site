  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const moveTEToSection = () => {
        ...
        // Apply exact styles from the real placeholder element (so it doesn't change
        // when TE is reparented inside `.dark6-page` which has `!important` overrides).
        const targetTEStyles = window.getComputedStyle(targetTE);
        const fontFamily = targetTEStyles.fontFamily;
        const color = targetTEStyles.color;
        const fontStyle = targetTEStyles.fontStyle;
        const fontWeight = targetTEStyles.fontWeight;

        teContainer.style.setProperty("font-family", fontFamily, "important");
        teContainer.style.setProperty("color", color, "important");
        teContainer.style.setProperty("font-style", fontStyle, "important");
        teContainer.style.setProperty("font-weight", fontWeight, "important");

        tClone.style.setProperty("font-family", fontFamily, "important");
        tClone.style.setProperty("color", color, "important");
        tClone.style.setProperty("font-style", fontStyle, "important");
        tClone.style.setProperty("font-weight", fontWeight, "important");

        eClone.style.setProperty("font-family", fontFamily, "important");
        eClone.style.setProperty("color", color, "important");
        eClone.style.setProperty("font-style", fontStyle, "important");
        eClone.style.setProperty("font-weight", fontWeight, "important");
      };
      ...
      const moveTEToBody = () => {
        ...
        // Keep font/color consistent when moved back to `body`.
        const targetTEStyles = window.getComputedStyle(targetTE);
        const fontFamily = targetTEStyles.fontFamily;
        const color = targetTEStyles.color;
        const fontStyle = targetTEStyles.fontStyle;
