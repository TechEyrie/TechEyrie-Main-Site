...
export default function HeroProblemServicesCombined({ theme = "light" }) {
  ...
  return (
    <main
      ref={wrapperRef}
      className="hero-problem-services-combined dark7-luxury-combined relative overflow-hidden transition-colors duration-500"
      style={bgStyle}
    >
      {theme === "dark" && (
        <>
          ...
          <div
            ...
            style={{
              ...
              background:
                "linear-gradient(to bottom, rgba(10,46,50,0.35) 0%, rgba(10,46,50,0) 100%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, #0f2219 0%, rgba(15,34,25,0) 100%)",
            }}
          />
        </>
      )}
          ...
          <>
            ...
            <div
              ...
              style={{
                ...
                transform: "translate(-50%, -50%)",
                backgroundImage:
                  "radial-gradient(circle at center, rgba(200,196,188,0.5) 0%, rgba(10,46,50,0.28) 35%, rgba(15,34,25,0) 72%)",
                mixBlendMode: "screen",
                opacity: 0.12,
                filter: "blur(18px)",
              }}
            ...
            <>
              ...
              <div
                ...
                style={{
                  ...
                  transform: "translate(-50%, -50%)",
                  backgroundImage:
                    "radial-gradient(circle at center, rgba(200,196,188,0.45) 0%, rgba(10,46,50,0.28) 35%, rgba(15,34,25,0) 72%)",
                  mixBlendMode: "screen",
                  opacity: 0,
                  filter: "blur(18px)",
                }}
            ...
            <>
              ...
              <div
                ...
                style={{
                  ...
                  transform: "translate(-50%, -50%)",
                  backgroundImage:
                    "radial-gradient(circle at center, rgba(156,176,168,0.62) 0%, rgba(10,46,50,0.26) 35%, rgba(22,45,36,0) 72%)",
                  mixBlendMode: "screen",
                  opacity: 0,
                  filter: "blur(18px)",
                }}
