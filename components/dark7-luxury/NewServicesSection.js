  ...
  const bgStyle =
    theme === "dark"
      ? {
          ...
          background:
            "linear-gradient(to bottom, #0a0a0a 0%, #0a0a0a 18%, #1e3d30 42%, #0f1814 68%, #0a0a0a 100%)",
        }
      ...
      >
          ...
          <>
            ...
            <div
              ...
              style={{
                ...
                background:
                  "linear-gradient(to bottom, rgba(10,46,50,0.9) 0%, rgba(10,46,50,0) 100%)",
              }}
            />
            <div
        ...
        <div className="relative z-10 mx-auto max-w-[1800px] px-4 sm:px-6 md:px-8">
          ...
          <div className="mb-6 sm:mb-8 flex items-center gap-2 sm:gap-3">
            <span className="inline-flex h-4 w-4 sm:h-5 sm:w-5 rounded-sm bg-[#c8c4bc]" />
            <span
            ...
            <div className="relative w-full">
              <div className="lg:sticky lg:top-8">
                <div className="relative w-full service-card">
                  ...
                  <span className="pointer-events-none absolute left-3 top-3 sm:left-4 sm:top-4 md:left-6 md:top-6 h-6 w-4 sm:h-10 sm:w-7 md:h-12 md:w-8 bg-[#c8c4bc] z-10" />
                  <span className="pointer-events-none absolute left-10 top-14 sm:left-16 sm:top-24 md:left-20 md:top-32 h-5 w-3 sm:h-8 sm:w-5 md:h-10 md:w-6 bg-[#c8c4bc] z-10" />
                  ...
                  {!isDesktop && activeId && (
                    <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 bg-gradient-to-t from-black/80 via-black/35 to-transparent px-4 pb-4 pt-10 sm:px-5 sm:pb-5">
                      <p className="font-merriweather text-[11px] sm:text-[12px] uppercase tracking-[0.14em] text-[#c8c4bc] mb-1">
                        Featured service
                      </p>
                  ...
                  return (
                    <article
                      ...
                      className={`
                        ...
                        ${
                          !isDesktop && isActive
                            ? "border-[#c8c4bc]/40 shadow-[0_12px_40px_rgba(0,0,0,0.22)]"
                            : ""
                        }
                      `}
                    >
                      <div className={`${!isDesktop ? "flex items-start justify-between gap-3" : ""}`}>
                        ...
                        {!isDesktop && (
                          <Link
                            ...
                            className={`relative flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-[6px] bg-[#c8c4bc] flex-shrink-0 ${
                      ...
                      >
                        ...
                        {isDesktop && (
                          <Link
                            href={`/services/${service.id}`}
                            className={`relative flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-[6px] bg-[#c8c4bc] transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-1 flex-shrink-0 ${
                              theme === "dark"
                            ...
                            <span className="absolute inset-0 flex items-center justify-center translate-x-[-12px] translate-y-[12px] opacity-0 transition-all duration-500 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:opacity-100">
                              <svg width="12" height="12" className="sm:w-4 sm:h-4" viewBox="0 0 14 14" aria-hidden="true">
                                <path
                                  d="M1 13L13 1M13 1H5M13 1V9"
                                  fill="none"
                                  stroke={theme === "dark" ? "#111111" : "#c8c4bc"}
                                  strokeWidth="2"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                                />
