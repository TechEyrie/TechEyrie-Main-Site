...
//               <span className="inline-flex h-5 w-5 rounded-sm bg-[#c8c4bc]" />
//               <span
...
//               {/* Green accent blocks */}
//               <span className="pointer-events-none absolute left-6 top-6 h-12 w-8 bg-[#c8c4bc]" />
//               <span className="pointer-events-none absolute left-20 top-32 h-10 w-6 bg-[#c8c4bc]" />
//             </div>
...
//                           className={`relative flex h-10 w-10 items-center justify-center rounded-[6px] bg-[#c8c4bc] transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-1 ${
//                             theme === "dark"
        ...
        <div className="relative z-10 mx-auto max-w-[1800px] px-4 sm:px-6 md:px-8">
          ...
          <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 lg:flex-row">
            ...
            <div className="relative w-full lg:w-[28%] service-card">
              ...
              <span className="pointer-events-none absolute left-3 top-3 sm:left-4 sm:top-4 md:left-6 md:top-6 h-8 w-6 sm:h-10 sm:w-7 md:h-12 md:w-8 bg-[#c8c4bc] z-10" />
              <span className="pointer-events-none absolute left-12 top-20 sm:left-16 sm:top-24 md:left-20 md:top-32 h-6 w-4 sm:h-8 sm:w-5 md:h-10 md:w-6 bg-[#c8c4bc] z-10" />
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-4 sm:mt-6 flex items-end justify-between gap-3 sm:gap-4">
                        ...
                        <Link
                          href={`/services/${service.id}`}
                          className={`relative flex h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 items-center justify-center rounded-[6px] bg-[#c8c4bc] transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-1 flex-shrink-0 ${
                            theme === "dark"
                              ? "group-hover:bg-white"
                              : "group-hover:bg-black"
                          }`}
