          ...
          <div className="grid items-start gap-8 sm:gap-10 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1.1fr)] mb-20 sm:mb-28 md:mb-32 lg:mb-40">
            <div ref={titleContainerRef}>
              <div className="mb-4 flex items-center gap-3">
                <span className="inline-flex h-5 w-5 rounded-sm" style={{ backgroundColor: theme === "dark" ? "#c8c4bc" : "#013825" }} />
                <p
      ...
      {metric.label}
                          ...
                          >
                            <Link
                              ...
                              className="group/arrow flex h-full w-full items-center justify-center rounded-md bg-[#c8c4bc] transition-all duration-500 ease-out hover:bg-black hover:scale-105"
