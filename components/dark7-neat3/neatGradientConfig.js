/** Neat gradient config for /dark7-neat3 hero + joint */
export const neat3GradientConfig = {
  colors: [
    { color: "#16B31C", enabled: true },
    { color: "#54CB7A", enabled: true },
    { color: "#96CEA4", enabled: true },
    { color: "#11E052", enabled: true },
