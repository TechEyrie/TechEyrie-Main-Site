...
import FeatherThreeHeroBackground from "./FeatherThreeHeroBackground";
import "./FeatherThreeHero.css";

if (typeof window !== "undefined") {
  gsap.registerPlugin(ScrollTrigger);
}

export default function HeroSectionMediaSlot({ theme = "light", sharedBackground = false, threeHero = false }) {
  ...
  return (
    ...
    >
      ...
      <section
        ref={heroSectionRef}
        className={`relative overflow-visible pt-32 md:pt-40 pb-0${threeHero ? " dark7-three-hero" : ""}`}
        style={{
      ...
      >
        {threeHero && theme === "dark" && (
          <FeatherThreeHeroBackground sectionRef={heroSectionRef} />
        )}
        {theme === "dark" && !threeHero && (
          <div
        ...
        <div className={`relative z-10 mx-auto max-w-[1800px] px-4 md:px-6 lg:px-10 min-h-0 flex flex-col justify-between pt-12${threeHero ? " feather-three-hero-content" : ""}`}>
