...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    // ── EAGLE POSITION (dark7-three22 / three3 / three4 hero) ──────────────────
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-three22). First value = camera X.
      ...
      ScrollTrigger.getById("dark7-three22-eagle-hero")?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          ...
          ease: "none",
          scrollTrigger: {
            id: embeddedScroll ? "dark7-three22-eagle-hero" : "eagle-scroll-scene",
            trigger: triggerEl,
