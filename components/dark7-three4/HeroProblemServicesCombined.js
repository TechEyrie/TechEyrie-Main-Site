...
import RealProblemSection from "../dark7/RealProblemSection";
import NewServicesSection from "../dark7/NewServicesSection";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div ref={heroWrapRef} className="relative" style={heroSurfaceStyle}>
          {theme === "dark" && (
            <>
              <div
                ref={heroNoiseRef}
