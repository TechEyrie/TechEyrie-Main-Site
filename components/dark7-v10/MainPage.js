...
import {
  initDark7V10LenisScroll,
  destroyDark7V10LenisScroll,
  refreshDark7V10ScrollTriggers,
  markDark7V10ScrollLayoutSettled,
  hasActiveDark7V10Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V10Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V10ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V10ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V10ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V10LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v10-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
