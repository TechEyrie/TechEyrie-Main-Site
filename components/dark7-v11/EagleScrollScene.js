...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v11). First value = camera X.
      ...
      ScrollTrigger.getById(DARK7_V11_HERO_PIN_ID)?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          ...
          scrollTrigger: Dark7V11ScrollTrigger({
            id: embeddedScroll ? DARK7_V11_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V11ScrollTriggers();
        const progress =
          getDark7V11ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
