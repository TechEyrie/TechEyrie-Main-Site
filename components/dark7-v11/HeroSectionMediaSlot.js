...
import {
  Dark7V11ScrollTrigger,
  DARK7_V11_HERO_PIN_ID,
...
export default function HeroSectionMediaSlot({
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      try {
        ...
        const eagleTrigger = ScrollTrigger.getById(DARK7_V11_HERO_PIN_ID);
    ...
    window.addEventListener("dark7-v11-scroll", handleScroll);
    handleScroll();
    return () => {
      window.removeEventListener("scroll", handleScroll);
      window.removeEventListener("dark7-v11-scroll", handleScroll);
    };
  }, []);
  ...
  return (
    ...
    >
      ...
      <section
        ref={heroSectionRef}
        className={`dark7-v11-hero relative z-30 overflow-visible pb-0${
          theme === "dark" ? " dark7-v11-hero-dark" : ""
        }`}
        style={theme === "dark" && !sharedBackground ? dark7HeroSurfaceStyle() : undefined}
      >
        <div
          ref={heroPinRef}
          className="dark7-v11-hero-pin relative z-[1] h-[100svh] min-h-[100svh] w-full overflow-visible"
        >
          {theme === "dark" && (
            <>
          ...
          <div
            ref={heroContentRef}
            className="dark7-v11-hero-content absolute inset-0 z-20 flex flex-col pt-36 md:pt-44 lg:pt-48"
          >
            <div className="relative z-10 mx-auto flex h-full w-full max-w-[1800px] flex-col px-4 md:px-6 lg:px-10">
              <div className="hero-left-column flex min-h-0 flex-col pt-10 md:pt-12 lg:flex-1 lg:h-full lg:max-w-[900px] lg:grid lg:grid-rows-[auto_minmax(0,0.28fr)_auto_1fr_auto]">
                <div
                  ...
                  className="dark7-v11-hero-title max-w-full lg:max-w-[1600px] xl:max-w-[1800px]"
                >
      ...
      <section
        ...
        id="discover"
        className="dark7-v11-portfolio relative z-20 w-full overflow-visible py-0 pb-0"
      >
        <div className="relative z-10 mx-auto w-full max-w-[1800px] px-4 sm:px-6 lg:px-8">
          <header className="mb-12 text-center sm:mb-16">
            <p
              className={`dark7-v11-portfolio-eyebrow mb-4 flex items-center justify-center gap-2 font-playfair text-base sm:mb-6 sm:gap-3 sm:text-lg md:text-xl lg:text-2xl ${
            ...
            <h2 className="dark7-v11-portfolio-title font-italiana text-3xl leading-tight text-[#162D24] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
              <span className="dark7-v11-portfolio-title-lead font-light text-[#162D24]">
                Creating impact for businesses in{" "}
              </span>
              <span className="dark7-v11-portfolio-city-pill relative -top-[2px] inline-flex min-w-[6ch] items-center justify-center overflow-hidden rounded-xl bg-[#1D322740] px-3 py-1 align-middle text-[#F7F3F0]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {mediaAssets.map((item, index) => (
              <div key={index} className="flex flex-col items-center">
                <div
                  className={`dark7-v11-portfolio-card relative flex flex-col w-full ${
                  ...
                  >
                    <Link href={item.link} className="block h-full">
                      <div className="px-4 sm:px-6 py-5 sm:py-6 flex flex-col justify-center h-full">
                        <h3 className="dark7-v11-portfolio-card-title font-merriweather font-light leading-snug tracking-tight mb-2 transition-colors duration-300">
                          {item.title}
                        </h3>
                        <div className="flex flex-wrap gap-2">
                          {item.buttons.map((button, btnIndex) => {
                            ...
                            <span
                              key={btnIndex}
                              className={`dark7-v11-portfolio-card-tag font-merriweather border rounded-full transition-colors duration-300 ${
