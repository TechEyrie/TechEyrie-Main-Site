...
import {
  initDark7V11LenisScroll,
  destroyDark7V11LenisScroll,
  refreshDark7V11ScrollTriggers,
  markDark7V11ScrollLayoutSettled,
  hasActiveDark7V11Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V11Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V11ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V11ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V11ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V11LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v11-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
