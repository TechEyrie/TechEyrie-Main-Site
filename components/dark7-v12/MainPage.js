...
import {
  initDark7V12LenisScroll,
  destroyDark7V12LenisScroll,
  refreshDark7V12ScrollTriggers,
  markDark7V12ScrollLayoutSettled,
  hasActiveDark7V12Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V12Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V12ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V12ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V12ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V12LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v12-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
