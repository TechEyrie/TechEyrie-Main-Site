...
import {
  initDark7V13LenisScroll,
  destroyDark7V13LenisScroll,
  refreshDark7V13ScrollTriggers,
  markDark7V13ScrollLayoutSettled,
  hasActiveDark7V13Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V13Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V13ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V13ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V13ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V13LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v13-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
