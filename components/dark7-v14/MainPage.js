...
import {
  initDark7V14LenisScroll,
  destroyDark7V14LenisScroll,
  refreshDark7V14ScrollTriggers,
  markDark7V14ScrollLayoutSettled,
  hasActiveDark7V14Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V14Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V14ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V14ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V14ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V14LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v14-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
