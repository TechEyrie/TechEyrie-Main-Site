...
import {
  initDark7V15LenisScroll,
  destroyDark7V15LenisScroll,
  refreshDark7V15ScrollTriggers,
  markDark7V15ScrollLayoutSettled,
  hasActiveDark7V15Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V15Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V15ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V15ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V15ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V15LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v15-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
