...
function BlogCtaLink() {
  const [ctaHovered, setCtaHovered] = useState(false);

  return (
    <Link
      href="/blog"
      className={`hero-cta-btn blogs-cta-btn inline-flex cursor-pointer items-center justify-center px-5 py-2.5 font-merriweather text-[16px] font-light tracking-tight transition-colors duration-300 md:px-6 md:py-3 md:text-[18px] ${
...
const BlogsSection = ({ theme = "light", sharedBackground = false }) => {
  ...
  const triggerElectricalAnimation = useCallback(() => {
    ...
    const accentOriginalColor = "#F7F3F0";
  ...
  return (
    <section 
      ref={sectionRef}
      className="dark7-v16-blogs relative w-full py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 overflow-hidden transition-colors duration-500"
      style={bgStyle}
    >
      ...
      <div className="relative z-[2] w-full max-w-[1500px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="w-full mx-auto mb-10 sm:mb-14 md:mb-16 lg:mb-20 xl:mb-24">
          ...
          <div ref={titleRef} className="mb-6 sm:mb-8 md:mb-10 text-center">
            <h2
              className="blogs-heading leading-[1.02] tracking-[0.01em] text-[#F7F3F0]"
              style={{ color: headingColor }}
            >
              <span
                className="insights-by-text real-problem-title-line block font-italiana font-light tracking-[0.01em]"
                style={{ color: headingColor }}
              >
                Not Built for Everyone
              </span>
              <span
                className="new-engen-text real-problem-title-line block font-playfair font-light italic"
                style={{ color: headingColor }}
              >
