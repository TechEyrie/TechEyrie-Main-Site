...
import {
  Dark7V16ScrollTrigger,
  getDark7V16ScrollTop,
  refreshDark7V16ScrollTriggers,
  notifyHeroPinReady,
  DARK7_V16_HERO_PIN_ID,
...
/**
 * Hero leaf families — v16 — neon Noomo lime (sharp bright leaves)
 * root/shadow = dark base | tip/highlight = bright tip
 */
const HERO_TOP_PALETTE = [
  { hue: 0.33, color: "#00B020", shadow: "#024810", highlight: "#7AFF30", emissive: "#012808", tip: "#D4FF40", root: "#011C06", stripe: "#088818", vane: "#18D028", alt: "#066818", cool: "#58F828" },
  { hue: 0.36, color: "#00C040", shadow: "#025018", highlight: "#88FF50", emissive: "#01300C", tip: "#E0FF58", root: "#012408", stripe: "#089830", vane: "#20E048", alt: "#087828", cool: "#68FF48" },
  { hue: 0.28, color: "#40B010", shadow: "#184808", highlight: "#A8FF28", emissive: "#0C2804", tip: "#F0FF38", root: "#0A1C04", stripe: "#308810", vane: "#68D018", alt: "#286810", cool: "#90F820" },
  { hue: 0.40, color: "#00B050", shadow: "#024820", highlight: "#60FF88", emissive: "#012810", tip: "#B8FFC0", root: "#011C0C", stripe: "#088840", vane: "#18D068", alt: "#066830", cool: "#50F890" },
  { hue: 0.34, color: "#00A828", shadow: "#024414", highlight: "#70FF38", emissive: "#012608", tip: "#C8FF48", root: "#011A06", stripe: "#068020", vane: "#14C830", alt: "#06641C", cool: "#48F030" },
  { hue: 0.30, color: "#28B018", shadow: "#104808", highlight: "#98FF30", emissive: "#082804", tip: "#E8FF40", root: "#061C04", stripe: "#1E8810", vane: "#48D020", alt: "#186810", cool: "#78F828" },
];

/** Lower / stretched leaves */
const HERO_BOTTOM_PALETTE = [
  { hue: 0.32, color: "#10D028", shadow: "#085818", highlight: "#90FF48", emissive: "#043010", tip: "#E8FF60", root: "#02280C", stripe: "#10A020", vane: "#2BE033", alt: "#0C8020", cool: "#70FF50" },
  { hue: 0.29, color: "#40D020", shadow: "#185810", highlight: "#B0FF40", emissive: "#0C3008", tip: "#FFFF58", root: "#0A2806", stripe: "#30A018", vane: "#60E830", alt: "#248014", cool: "#98FF48" },
  { hue: 0.38, color: "#10D058", shadow: "#085828", highlight: "#78FF90", emissive: "#043018", tip: "#D0FFD0", root: "#022810", stripe: "#10A048", vane: "#30E878", alt: "#0C8038", cool: "#68FFA0" },
  { hue: 0.31, color: "#20D830", shadow: "#0C5C1C", highlight: "#98FF50", emissive: "#063414", tip: "#F0FF70", root: "#042C0E", stripe: "#18A828", vane: "#40F038", alt: "#108824", cool: "#80FF58" },
  { hue: 0.27, color: "#50D018", shadow: "#20580C", highlight: "#C0FF38", emissive: "#103006", tip: "#FFFF50", root: "#0C2804", stripe: "#38A010", vane: "#78E828", alt: "#2C8010", cool: "#A8FF40" },
  { hue: 0.35, color: "#08C840", shadow: "#045420", highlight: "#70FF68", emissive: "#022C12", tip: "#D8FF98", root: "#01240C", stripe: "#069838", vane: "#20E058", alt: "#06782C", cool: "#58FF80" },
];
...
function applyFeatherSurfaceShader(
  ...
  material.customProgramCacheKey = () =>
    `feather-leaf-neon-v16-${isWing ? 1 : 0}-${heroWingLook ? 1 : 0}-${axis?.axisIdx ?? "b"}`;
...
float featherNoise(vec2 p) {
  ...
  if (uHeroWingLook > 0.5) {
    ...
    vec3 accentWarm = vec3(0.95, 1.0, 0.22);
    vec3 accentCool = vec3(0.55, 1.0, 0.55);
    vec3 accentNeon = vec3(0.50, 1.0, 0.15);
    ...
    feather = mix(feather, cDeep, rim * 0.16);

    // Soft flecks only
    feather = mix(feather, cDeep, (1.0 - softGrain) * 0.06 * (1.0 - t));
    feather = mix(feather, cTipHot, softGrain2 * 0.16 * t);
...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v16).
      ...
      ScrollTrigger.getById(DARK7_V16_HERO_PIN_ID)?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          progress: 1,
          ease: "none",
          scrollTrigger: Dark7V16ScrollTrigger({
            id: embeddedScroll ? DARK7_V16_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V16ScrollTriggers();
        const progress =
          getDark7V16ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
        applyScrollProgress(progress);
        onScrollProgressRef.current?.(progress <= 0.001 ? 0 : progress);
      });

      window.setTimeout(() => {
        refreshDark7V16ScrollTriggers(true);
        const progress =
          getDARK7_V16ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
        applyScrollProgress(progress);
        onScrollProgressRef.current?.(progress <= 0.001 ? 0 : progress);
        if (embeddedScroll) {
          notifyHeroPinReady();
