...
import {
  initDark7V16LenisScroll,
  destroyDark7V16LenisScroll,
  refreshDark7V16ScrollTriggers,
  markDark7V16ScrollLayoutSettled,
  hasActiveDark7V16Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V16Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V16ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V16ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V16ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V16LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v16-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
