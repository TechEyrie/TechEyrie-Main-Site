...
import {
  Dark7V17ScrollTrigger,
  getDark7V17ScrollTop,
  refreshDark7V17ScrollTriggers,
  notifyHeroPinReady,
  DARK7_V17_HERO_PIN_ID,
...
/**
 * Hero leaf families — v17 — teal jade / mint mix (cool Noomo leaves)
 * root/shadow = dark base | tip/highlight = bright tip
 */
const HERO_TOP_PALETTE = [
  { hue: 0.42, color: "#0A7A58", shadow: "#033028", highlight: "#48F0B0", emissive: "#021A14", tip: "#A0FFE0", root: "#011410", stripe: "#086048", vane: "#18C890", alt: "#0A4C3C", cool: "#40E8C0" },
  { hue: 0.38, color: "#0A8850", shadow: "#033820", highlight: "#50F890", emissive: "#021E10", tip: "#B0FFC0", root: "#01180C", stripe: "#086C40", vane: "#18D070", alt: "#0A5434", cool: "#48F0A0" },
  { hue: 0.45, color: "#087868", shadow: "#023030", highlight: "#40E8D0", emissive: "#011818", tip: "#98FFF0", root: "#011414", stripe: "#065C50", vane: "#14C0B0", alt: "#084848", cool: "#38D8C8" },
  { hue: 0.36, color: "#0C9040", shadow: "#043818", highlight: "#60F870", emissive: "#021E0C", tip: "#C0FF90", root: "#011808", stripe: "#0A7030", vane: "#20D058", alt: "#0C5828", cool: "#50F080" },
  { hue: 0.40, color: "#0A8060", shadow: "#033428", highlight: "#50F0C0", emissive: "#021C14", tip: "#B0FFE8", root: "#011610", stripe: "#086448", vane: "#18C8A0", alt: "#0A5040", cool: "#48E8C8" },
  { hue: 0.34, color: "#128848", shadow: "#063820", highlight: "#68F088", emissive: "#041E10", tip: "#C8FFA8", root: "#02180C", stripe: "#0E6C38", vane: "#28C868", alt: "#105430", cool: "#58E898" },
];

/** Lower / stretched leaves */
const HERO_BOTTOM_PALETTE = [
  { hue: 0.41, color: "#10A070", shadow: "#064838", highlight: "#60FFC0", emissive: "#03281C", tip: "#C0FFF0", root: "#022016", stripe: "#0C8060", vane: "#28E0A8", alt: "#0A6450", cool: "#58F8D0" },
  { hue: 0.37, color: "#14A858", shadow: "#084C28", highlight: "#70FF98", emissive: "#042C14", tip: "#D0FFC0", root: "#02240E", stripe: "#108848", vane: "#30E880", alt: "#0C6C3C", cool: "#68F8A8" },
  { hue: 0.44, color: "#0C9880", shadow: "#044840", highlight: "#58F0E0", emissive: "#022820", tip: "#B8FFF8", root: "#012018", stripe: "#087868", vane: "#20D0C0", alt: "#085C54", cool: "#48E8D8" },
  { hue: 0.39, color: "#10A868", shadow: "#064C30", highlight: "#68FFB0", emissive: "#032C18", tip: "#C8FFE0", root: "#022412", stripe: "#0C8850", vane: "#28E098", alt: "#0A6C44", cool: "#60F8C0" },
  { hue: 0.33, color: "#20A848", shadow: "#0C4C20", highlight: "#80FF70", emissive: "#062C10", tip: "#E0FFA0", root: "#04240C", stripe: "#188838", vane: "#40E060", alt: "#146C30", cool: "#78F888" },
  { hue: 0.46, color: "#0A9088", shadow: "#044448", highlight: "#50E8E8", emissive: "#022424", tip: "#B0FFFF", root: "#011C1C", stripe: "#087070", vane: "#18C8C8", alt: "#085858", cool: "#40D8D8" },
];
...
function applyFeatherSurfaceShader(
  ...
  material.customProgramCacheKey = () =>
    `feather-leaf-jade-v17-${isWing ? 1 : 0}-${heroWingLook ? 1 : 0}-${axis?.axisIdx ?? "b"}`;
...
float featherNoise(vec2 p) {
  ...
  if (uHeroWingLook > 0.5) {
    ...
    vec3 accentWarm = vec3(0.70, 0.95, 0.40);
    vec3 accentCool = vec3(0.30, 0.95, 0.85);
    vec3 accentNeon = vec3(0.25, 0.90, 0.60);
    vec3 accentPick = family < 1.5 ? accentCool : (family < 3.5 ? accentNeon : accentWarm);
    ...
    feather = mix(feather, cDeep, rim * 0.20);

    // Soft flecks only
    feather = mix(feather, cDeep, (1.0 - softGrain) * 0.10 * (1.0 - t));
    feather = mix(feather, cTipHot, softGrain2 * 0.12 * t);
...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v17).
      ...
      ScrollTrigger.getById(DARK7_V17_HERO_PIN_ID)?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          progress: 1,
          ease: "none",
          scrollTrigger: Dark7V17ScrollTrigger({
            id: embeddedScroll ? DARK7_V17_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V17ScrollTriggers();
        const progress =
          getDark7V17ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
        applyScrollProgress(progress);
        onScrollProgressRef.current?.(progress <= 0.001 ? 0 : progress);
      });

      window.setTimeout(() => {
        refreshDark7V17ScrollTriggers(true);
        const progress =
          getDARK7_V17ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
        applyScrollProgress(progress);
        onScrollProgressRef.current?.(progress <= 0.001 ? 0 : progress);
        if (embeddedScroll) {
          notifyHeroPinReady();
