...
import {
  initDark7V17LenisScroll,
  destroyDark7V17LenisScroll,
  refreshDark7V17ScrollTriggers,
  markDark7V17ScrollLayoutSettled,
  hasActiveDark7V17Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V17Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V17ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V17ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V17ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V17LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v17-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
