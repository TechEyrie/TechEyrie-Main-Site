...
import {
  initDark7V18LenisScroll,
  destroyDark7V18LenisScroll,
  refreshDark7V18ScrollTriggers,
  markDark7V18ScrollLayoutSettled,
  hasActiveDark7V18Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V18Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V18ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V18ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V18ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V18LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v18-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
