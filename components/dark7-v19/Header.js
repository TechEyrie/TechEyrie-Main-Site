...
import { getDark7V19ScrollTop } from "./lenisScrollTrigger";
...
export default function Header({ theme = "light" }) {
  ...
  useEffect(() => {
    const updateHeaderOnScroll = () => {
      ...
      const currentScrollY = getDark7V19ScrollTop();
      const lastScrollY = lastScrollYRef.current;
      const heroEl = document.querySelector(".dark7-v19-hero");
      const inHero = heroEl
    ...
    window.addEventListener("dark7-v19-scroll", updateHeaderOnScroll);
    window.addEventListener("scroll", updateHeaderOnScroll, { passive: true });
    updateHeaderOnScroll();

    return () => {
      window.removeEventListener("dark7-v19-scroll", updateHeaderOnScroll);
  ...
  return (
    <>
      <style jsx global>{`
        ...
        .group:hover .dark7-v19-header-arrow-btn,
        .dropdown-card:hover .dark7-v19-header-arrow-btn {
      ...
      <header
        className={`fixed left-0 right-0 top-0 z-[80] w-full max-w-full min-w-0 overflow-visible antialiased transition-transform duration-300 ${
          isCompactNav ? "dark7-v19-header--compact" : ""
        } ${
      ...
      >
        ...
        >
          ...
          <div className="hidden min-w-0 items-center gap-3 lg:flex">
            <div
              className="dark7-v19-header-nav-pill flex h-[45px] items-center gap-4 rounded-[14px] px-4 lg:px-5 shadow-[0_10px_30px_rgba(0,0,0,0.15)]"
              style={{
            ...
            >
                ...
                {navItems.map((item) => (
                  ...
                  >
                    {item.href ? (
                      <Link
                        href={item.href}
                        className="dark7-v19-header-nav-link flex h-full items-center gap-1.5 rounded-[8px] px-3.5 lg:px-4 font-merriweather text-[13px] font-light leading-none tracking-[0.04em] transition-all duration-200 cursor-pointer"
                        style={{
              ...
              <div className="flex h-full flex-shrink-0 items-center pl-2">
                ...
                <button
                  ...
                  className="dark7-v19-header-nav-link group flex h-full cursor-pointer items-center gap-2"
                >
                  <span
            ...
            <button
              ...
              className="dark7-v19-header-quote-btn get-quote-btn group flex h-[45px] flex-shrink-0 items-center gap-2 rounded-[14px] px-5 transition-all duration-300 shadow-[0_10px_30px_rgba(0,0,0,0.15)]"
              style={{
                backgroundColor: navPillBg,
                border: navPillBorder,
              }}
        ...
        <div
          ...
          className={`dark7-v19-mega-menu hidden lg:block absolute left-0 right-0 top-full z-[90] -mt-4 pt-1 transition-all duration-300 ${
