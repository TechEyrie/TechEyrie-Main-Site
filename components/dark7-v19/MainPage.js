...
import {
  initDark7V19LenisScroll,
  destroyDark7V19LenisScroll,
  refreshDark7V19ScrollTriggers,
  markDark7V19ScrollLayoutSettled,
  hasActiveDark7V19Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V19Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V19ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V19ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V19ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V19LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v19-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
