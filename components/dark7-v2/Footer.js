  ...
  const footerBgStyle =
    theme === 'dark'
      ? {
          ...
          backgroundImage:
            'linear-gradient(to bottom, #1e352c 0%, #1a3028 38%, #152820 68%, #122218 100%)',
        }
    ...
    <>
      <style jsx global>{`
        .dark5-footer {
          ...
          background-image: linear-gradient(to bottom, #1e352c 0%, #1a3028 38%, #152820 68%, #122218 100%) !important;
        }
