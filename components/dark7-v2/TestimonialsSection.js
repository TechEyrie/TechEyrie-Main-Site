...
export default function TestimonialsSection({ theme, sharedBackground = false }) {
  ...
  const bgColorStyle = isDark
    ? sharedBackground
      ...
      : {
          background:
            "linear-gradient(to bottom, #f5f1ee 0%, #f5f1ee 15%, #d4d8d0 24%, #a8aea4 32%, #6e776c 40%, #3d4a3c 48%, #101e13 56%, #101e13 78%, #1a2218 86%, #2a2c1f 93%, #3d3f2a 100%)",
        }
  ...
  return (
    <div
      className={`dark7-v2-testimonials relative min-h-[150vh] ${textColor} selection:bg-indigo-500/30 transition-colors duration-500`}
      style={bgColorStyle}
    >
        <div className="relative">
            ...
            <div className="sticky top-0 h-screen flex flex-col items-center justify-center -z-0 overflow-hidden px-4">
                <h1 className={`testimonials-heading font-italiana font-light text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] xl:text-[64px] 2xl:text-[72px] 3xl:text-[80px] text-center leading-tight tracking-[0.01em] ${headingColor} transition-colors duration-500`}>
