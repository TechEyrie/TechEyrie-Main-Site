...
import {
  Dark7V20ScrollTrigger,
  getDark7V20ScrollTop,
  refreshDark7V20ScrollTriggers,
  notifyHeroPinReady,
  DARK7_V20_HERO_PIN_ID,
...
/**
 * Hero leaf families — v20 — mixed Noomo leaf salad (lime + teal + olive)
 * root/shadow = dark base | tip/highlight = bright tip
 */
const HERO_TOP_PALETTE = [
  { hue: 0.33, color: "#0E9028", shadow: "#043814", highlight: "#68F040", emissive: "#021E0A", tip: "#C8FF50", root: "#011806", stripe: "#0A7020", vane: "#1CC830", alt: "#0C5820", cool: "#50E838" },
  { hue: 0.42, color: "#0A8870", shadow: "#033830", highlight: "#50F0C8", emissive: "#021E18", tip: "#B0FFE8", root: "#011814", stripe: "#086C58", vane: "#18C8A8", alt: "#0A5448", cool: "#48E8C0" },
  { hue: 0.28, color: "#3A8820", shadow: "#183810", highlight: "#98F038", emissive: "#0C1E08", tip: "#E8FF48", root: "#081806", stripe: "#2A6818", vane: "#58C028", alt: "#245018", cool: "#80E840" },
  { hue: 0.38, color: "#0C9050", shadow: "#043820", highlight: "#58F888", emissive: "#021E10", tip: "#B8FFB0", root: "#01180C", stripe: "#0A7038", vane: "#1CD070", alt: "#0C5830", cool: "#50F098" },
  { hue: 0.30, color: "#289020", shadow: "#103810", highlight: "#88F030", emissive: "#081E08", tip: "#D8FF40", root: "#061806", stripe: "#1E7018", vane: "#48C828", alt: "#185818", cool: "#70E838" },
  { hue: 0.45, color: "#088878", shadow: "#023838", highlight: "#48E8E0", emissive: "#011E1E", tip: "#A8FFF8", root: "#011818", stripe: "#066C68", vane: "#14C0C0", alt: "#085450", cool: "#40D8D0" },
];

/** Lower / stretched leaves */
const HERO_BOTTOM_PALETTE = [
  { hue: 0.32, color: "#18B030", shadow: "#0A4820", highlight: "#80FF50", emissive: "#042810", tip: "#E0FF68", root: "#02200C", stripe: "#129028", vane: "#30E040", alt: "#0E7428", cool: "#68F858" },
  { hue: 0.41, color: "#10A880", shadow: "#064840", highlight: "#68FFD0", emissive: "#032820", tip: "#C8FFF0", root: "#022018", stripe: "#0C8868", vane: "#28E0B8", alt: "#0A6C54", cool: "#58F8D8" },
  { hue: 0.27, color: "#50A820", shadow: "#204810", highlight: "#B0FF40", emissive: "#102808", tip: "#F8FF50", root: "#0C2006", stripe: "#3C8818", vane: "#78D828", alt: "#306C18", cool: "#A0F048" },
  { hue: 0.37, color: "#14B060", shadow: "#084830", highlight: "#70FFA0", emissive: "#042818", tip: "#D0FFC8", root: "#022012", stripe: "#109050", vane: "#30E088", alt: "#0C7444", cool: "#68F8B0" },
  { hue: 0.31, color: "#30B028", shadow: "#144818", highlight: "#98FF48", emissive: "#0A280C", tip: "#F0FF60", root: "#062008", stripe: "#249020", vane: "#50E038", alt: "#1C7420", cool: "#80F850" },
  { hue: 0.44, color: "#0CA098", shadow: "#044848", highlight: "#58F0E8", emissive: "#022824", tip: "#B8FFFF", root: "#01201C", stripe: "#088078", vane: "#20D0C8", alt: "#0A645C", cool: "#48E0D8" },
];
...
function applyFeatherSurfaceShader(
  ...
  material.customProgramCacheKey = () =>
    `feather-leaf-mix-v20-${isWing ? 1 : 0}-${heroWingLook ? 1 : 0}-${axis?.axisIdx ?? "b"}`;
...
float featherNoise(vec2 p) {
  ...
  if (uHeroWingLook > 0.5) {
    ...
    vec3 accentWarm = vec3(0.90, 0.98, 0.25);
    vec3 accentCool = vec3(0.35, 0.95, 0.80);
    vec3 accentNeon = vec3(0.45, 1.0, 0.30);
    vec3 accentPick = family < 1.5 ? accentWarm : (family < 3.5 ? accentCool : accentNeon);
    ...
    feather = mix(feather, cDeep, rim * 0.18);

    // Soft flecks only
    feather = mix(feather, cDeep, (1.0 - softGrain) * 0.11 * (1.0 - t));
    feather = mix(feather, cTipHot, softGrain2 * 0.14 * t);
    ...
    feather = mix(vec3(luma), feather, 1.24);
...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v20).
      ...
      ScrollTrigger.getById(DARK7_V20_HERO_PIN_ID)?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          progress: 1,
          ease: "none",
          scrollTrigger: Dark7V20ScrollTrigger({
            id: embeddedScroll ? DARK7_V20_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V20ScrollTriggers();
        const progress =
          getDark7V20ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
      ...
      window.setTimeout(() => {
        ...
        const progress =
          getDARK7_V20ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
        applyScrollProgress(progress);
        onScrollProgressRef.current?.(progress <= 0.001 ? 0 : progress);
        if (embeddedScroll) {
          notifyHeroPinReady();
