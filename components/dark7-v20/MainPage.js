...
import {
  initDark7V20LenisScroll,
  destroyDark7V20LenisScroll,
  refreshDark7V20ScrollTriggers,
  markDark7V20ScrollLayoutSettled,
  hasActiveDark7V20Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V20Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V20ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V20ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V20ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V20LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v20-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
