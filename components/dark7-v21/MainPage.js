...
import {
  initDark7V21LenisScroll,
  destroyDark7V21LenisScroll,
  refreshDark7V21ScrollTriggers,
  markDark7V21ScrollLayoutSettled,
  hasActiveDark7V21Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V21Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V21ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V21ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V21ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V21LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v21-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
