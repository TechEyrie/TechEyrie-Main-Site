...
import {
  initDark7V22LenisScroll,
  destroyDark7V22LenisScroll,
  refreshDark7V22ScrollTriggers,
  markDark7V22ScrollLayoutSettled,
  hasActiveDark7V22Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V22Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V22ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V22ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V22ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V22LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v22-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
