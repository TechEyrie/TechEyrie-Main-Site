...
import {
  initDark7V23LenisScroll,
  destroyDark7V23LenisScroll,
  refreshDark7V23ScrollTriggers,
  markDark7V23ScrollLayoutSettled,
  hasActiveDark7V23Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V23Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V23ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V23ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V23ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V23LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v23-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
