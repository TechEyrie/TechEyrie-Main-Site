...
function MobileTechEyrieSection({ theme }) {
  ...
  return (
    <div className="relative w-full max-w-full min-w-0 overflow-x-clip">
      <section
        className="dark7-v23-tech-eyrie relative overflow-hidden transition-colors duration-500"
        style={bgStyle}
      >
        <SectionOverlays />
...
function DesktopTechEyrieSection({ theme }) {
  ...
  return (
    ...
    >
      <section
        ref={sectionRef}
        className="dark7-v23-tech-eyrie relative overflow-hidden transition-colors duration-500 sticky top-0 h-screen"
