...
import {
  initDark7V24LenisScroll,
  destroyDark7V24LenisScroll,
  refreshDark7V24ScrollTriggers,
  markDark7V24ScrollLayoutSettled,
  hasActiveDark7V24Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V24Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V24ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V24ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V24ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V24LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v24-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
