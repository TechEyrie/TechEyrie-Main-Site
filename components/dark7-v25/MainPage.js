...
import {
  initDark7V25LenisScroll,
  destroyDark7V25LenisScroll,
  refreshDark7V25ScrollTriggers,
  markDark7V25ScrollLayoutSettled,
  hasActiveDark7V25Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V25Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V25ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V25ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V25ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V25LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v25-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
