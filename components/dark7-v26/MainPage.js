...
import {
  initDark7V26LenisScroll,
  destroyDark7V26LenisScroll,
  refreshDark7V26ScrollTriggers,
  markDark7V26ScrollLayoutSettled,
  hasActiveDark7V26Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V26Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V26ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V26ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V26ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V26LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v26-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
