...
import {
  initDark7V27LenisScroll,
  destroyDark7V27LenisScroll,
  refreshDark7V27ScrollTriggers,
  markDark7V27ScrollLayoutSettled,
  hasActiveDark7V27Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V27Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V27ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V27ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V27ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V27LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v27-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
