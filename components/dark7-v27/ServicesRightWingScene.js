...
const SERVICES_WING_ID = "dark7-v27-services-right-wing";

/**
 * ═══════════════════════════════════════════════════════════════════════════
 * SERVICES LEFT-WING TUNING (v12 — inverse of v11)
 * File: components/dark7-v27/ServicesRightWingScene.js
 * Page: /dark7-v27  →  New Services section (left side)
 *
...
export default function ServicesRightWingScene({ sectionRef, className = "" }) {
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(section) {
      ...
      requestAnimationFrame(() => refreshDark7V27ScrollTriggers());
      window.setTimeout(() => refreshDark7V27ScrollTriggers(true), 400);
    }
