...
import {
  initDark7V28LenisScroll,
  destroyDark7V28LenisScroll,
  refreshDark7V28ScrollTriggers,
  markDark7V28ScrollLayoutSettled,
  hasActiveDark7V28Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V28Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V28ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V28ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V28ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V28LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v28-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
