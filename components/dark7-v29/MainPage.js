...
import {
  initDark7V29LenisScroll,
  destroyDark7V29LenisScroll,
  refreshDark7V29ScrollTriggers,
  markDark7V29ScrollLayoutSettled,
  hasActiveDark7V29Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V29Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V29ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V29ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V29ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V29LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v29-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
