...
export default function AirplaneHero({ theme = "dark", sharedBackground = false }) {
  ...
  const sectionBgStyle = dark7GradientSurfaceStyle(DARK7_GRADIENTS.airplane, "#263b33");
  const surfaceStyle =
  ...
  return (
    <section
      ref={sectionRef}
      className="dark7-v3-airplane-hero relative min-h-screen w-full flex flex-col justify-between overflow-hidden"
      style={{ cursor: "crosshair", ...surfaceStyle }}
    >
      {theme === "dark" && !sharedBackground && (
        <div
      ...
      <div className="relative z-20 flex-1 flex flex-col justify-start pt-24 md:pt-32 px-6 sm:px-12 md:px-20 lg:px-32">
        <div ref={textRef} className="max-w-xl lg:max-w-2xl">
          <h1 className="airplane-hero-heading font-italiana font-light text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] xl:text-[64px] 2xl:text-[72px] text-[#162d24] leading-[1.1] tracking-[0.01em]">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between gap-8 border-b border-white/20 pb-8">
          <div className="w-full md:w-2/3">
            <input type="email" placeholder="Enter your email"
              className="airplane-hero-input w-full bg-transparent border-none text-[#f6f2ee] font-merriweather text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] placeholder:text-[#a0a0a0] focus:outline-none focus:ring-0 transition-all" />
          </div>
          <Link href="/get-started"
