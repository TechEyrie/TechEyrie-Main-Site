...
import {
  Dark7V30ScrollTrigger,
  getDark7V30ScrollTop,
  refreshDark7V30ScrollTriggers,
  notifyHeroPinReady,
  DARK7_V30_HERO_PIN_ID,
...
/**
 * Hero leaf families — MID dark→medium greenish
 */
const HERO_TOP_PALETTE = [
  { hue: 0.36, color: "#1A5C32", shadow: "#0A2A18", highlight: "#4CB86A", emissive: "#0E3A22", tip: "#6FD090", root: "#061A10", stripe: "#144828", vane: "#2A7A44", alt: "#123820", cool: "#3A9A68" },
  { hue: 0.40, color: "#165848", shadow: "#082820", highlight: "#48B890", emissive: "#0C3830", tip: "#68D0B0", root: "#051814", stripe: "#104438", vane: "#247860", alt: "#0E342C", cool: "#38A888" },
  { hue: 0.33, color: "#1E5828", shadow: "#0C2814", highlight: "#58B848", emissive: "#123818", tip: "#78C868", root: "#08180C", stripe: "#184420", vane: "#2E7834", alt: "#14341C", cool: "#48A850" },
  { hue: 0.42, color: "#145850", shadow: "#082828", highlight: "#40B8A8", emissive: "#0C3834", tip: "#60D0C0", root: "#051818", stripe: "#104440", vane: "#207870", alt: "#0E3430", cool: "#34A898" },
  { hue: 0.35, color: "#1A6038", shadow: "#0A2C1C", highlight: "#50C070", emissive: "#0E3C24", tip: "#70D098", root: "#061A10", stripe: "#144C2C", vane: "#288048", alt: "#123824", cool: "#40A868" },
  { hue: 0.38, color: "#185840", shadow: "#0A2820", highlight: "#48B878", emissive: "#0C3828", tip: "#68D0A0", root: "#061814", stripe: "#124430", vane: "#267850", alt: "#103424", cool: "#3AA878" },
];

/** Outer leaves — mid green, brighter tips */
const HERO_BOTTOM_PALETTE = [
  { hue: 0.37, color: "#247848", shadow: "#0E3824", highlight: "#68D088", emissive: "#144C30", tip: "#90E0A8", root: "#0A2418", stripe: "#1C6038", vane: "#389858", alt: "#184830", cool: "#50C080" },
  { hue: 0.41, color: "#207868", shadow: "#0C3830", highlight: "#60D0B0", emissive: "#124C40", tip: "#88E0C8", root: "#082420", stripe: "#186050", vane: "#309888", alt: "#144838", cool: "#48C0A0" },
  { hue: 0.34, color: "#287838", shadow: "#10381C", highlight: "#78D060", emissive: "#164C24", tip: "#A0E088", root: "#0A2410", stripe: "#20602C", vane: "#409848", alt: "#184820", cool: "#58C058" },
  { hue: 0.43, color: "#1C7870", shadow: "#0C3834", highlight: "#58D0C0", emissive: "#104C44", tip: "#80E0D0", root: "#082420", stripe: "#146058", vane: "#2C9888", alt: "#104840", cool: "#44C0B0" },
  { hue: 0.36, color: "#247850", shadow: "#0E3828", highlight: "#68D090", emissive: "#144C34", tip: "#90E0B0", root: "#0A2418", stripe: "#1C603C", vane: "#369860", alt: "#164830", cool: "#50C088" },
  { hue: 0.39, color: "#207860", shadow: "#0C3830", highlight: "#60D0A0", emissive: "#124C3C", tip: "#88E0C0", root: "#08241C", stripe: "#186048", vane: "#309878", alt: "#144838", cool: "#48C098" },
];
...
function applyFeatherSurfaceShader(
  ...
  material.customProgramCacheKey = () =>
    `feather-leaf-veins-mid-v30-${isWing ? 1 : 0}-${heroWingLook ? 1 : 0}-${axis?.axisIdx ?? "b"}-${axis?.acrossIdx ?? "a"}`;
...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v30).
      ...
      ScrollTrigger.getById(DARK7_V30_HERO_PIN_ID)?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          progress: 1,
          ease: "none",
          scrollTrigger: Dark7V30ScrollTrigger({
            id: embeddedScroll ? DARK7_V30_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V30ScrollTriggers();
        const progress =
          getDark7V30ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
        applyScrollProgress(progress);
        onScrollProgressRef.current?.(progress <= 0.001 ? 0 : progress);
      });

      window.setTimeout(() => {
        refreshDark7V30ScrollTriggers(true);
        const progress =
          getDARK7_V30ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
        applyScrollProgress(progress);
        onScrollProgressRef.current?.(progress <= 0.001 ? 0 : progress);
        if (embeddedScroll) {
          notifyHeroPinReady();
