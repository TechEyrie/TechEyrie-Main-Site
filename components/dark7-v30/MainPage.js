...
import {
  initDark7V30LenisScroll,
  destroyDark7V30LenisScroll,
  refreshDark7V30ScrollTriggers,
  markDark7V30ScrollLayoutSettled,
  hasActiveDark7V30Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V30Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V30ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V30ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V30ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V30LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v30-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
