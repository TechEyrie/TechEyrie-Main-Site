...
import {
  Dark7V31ScrollTrigger,
  getDark7V31ScrollTop,
  refreshDark7V31ScrollTriggers,
  notifyHeroPinReady,
  DARK7_V31_HERO_PIN_ID,
...
/**
 * Hero leaf families — MEDIUM greenish (brighter living green)
 */
const HERO_TOP_PALETTE = [
  { hue: 0.36, color: "#2A7848", shadow: "#143828", highlight: "#68D088", emissive: "#1A5030", tip: "#90E8A8", root: "#0C2418", stripe: "#206038", vane: "#3C9858", alt: "#184830", cool: "#50C078" },
  { hue: 0.40, color: "#267868", shadow: "#123830", highlight: "#60D0B0", emissive: "#184C40", tip: "#88E8C8", root: "#0A2420", stripe: "#1C6050", vane: "#389888", alt: "#164838", cool: "#48C0A0" },
  { hue: 0.33, color: "#307838", shadow: "#18381C", highlight: "#78D060", emissive: "#1E5024", tip: "#A8E880", root: "#0E2410", stripe: "#24602C", vane: "#489848", alt: "#1C4820", cool: "#60C058" },
  { hue: 0.42, color: "#247870", shadow: "#123834", highlight: "#58D0C0", emissive: "#164C44", tip: "#80E8D0", root: "#0A2420", stripe: "#1A6058", vane: "#349888", alt: "#144840", cool: "#44C0B0" },
  { hue: 0.35, color: "#2C7850", shadow: "#143828", highlight: "#70D090", emissive: "#1C5034", tip: "#98E8B0", root: "#0C2418", stripe: "#22603C", vane: "#409860", alt: "#1A4830", cool: "#58C088" },
  { hue: 0.38, color: "#287860", shadow: "#123830", highlight: "#68D0A0", emissive: "#184C3C", tip: "#90E8C0", root: "#0A241C", stripe: "#1E6048", vane: "#3C9878", alt: "#164838", cool: "#50C098" },
];

/** Outer leaves — medium green, luminous tips */
const HERO_BOTTOM_PALETTE = [
  { hue: 0.37, color: "#389860", shadow: "#1A4830", highlight: "#80E8A0", emissive: "#246840", tip: "#B0F0C0", root: "#103020", stripe: "#2C7848", vane: "#50B870", alt: "#245838", cool: "#68D090" },
  { hue: 0.41, color: "#349888", shadow: "#184840", highlight: "#78E8C8", emissive: "#206850", tip: "#A8F0E0", root: "#0E3028", stripe: "#287868", vane: "#48B8A0", alt: "#205848", cool: "#60D0B8" },
  { hue: 0.34, color: "#409850", shadow: "#1E4824", highlight: "#90E878", emissive: "#286830", tip: "#C0F098", root: "#123014", stripe: "#347840", vane: "#60B858", alt: "#285830", cool: "#78D068" },
  { hue: 0.43, color: "#309890", shadow: "#164844", highlight: "#70E8D8", emissive: "#1E6860", tip: "#A0F0E8", root: "#0C302C", stripe: "#247870", vane: "#44B8A8", alt: "#1C5850", cool: "#58D0C8" },
  { hue: 0.36, color: "#389868", shadow: "#1A4834", highlight: "#80E8B0", emissive: "#246844", tip: "#B0F0C8", root: "#103020", stripe: "#2C784C", vane: "#50B880", alt: "#245838", cool: "#68D098" },
  { hue: 0.39, color: "#349880", shadow: "#18483C", highlight: "#78E8B8", emissive: "#20684C", tip: "#A8F0D0", root: "#0E3024", stripe: "#287860", vane: "#48B890", alt: "#205840", cool: "#60D0A8" },
];
...
function applyFeatherSurfaceShader(
  ...
  material.customProgramCacheKey = () =>
    `feather-leaf-veins-med-v31-${isWing ? 1 : 0}-${heroWingLook ? 1 : 0}-${axis?.axisIdx ?? "b"}-${axis?.acrossIdx ?? "a"}`;
...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v31).
      ...
      ScrollTrigger.getById(DARK7_V31_HERO_PIN_ID)?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          progress: 1,
          ease: "none",
          scrollTrigger: Dark7V31ScrollTrigger({
            id: embeddedScroll ? DARK7_V31_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V31ScrollTriggers();
        const progress =
          getDark7V31ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
        applyScrollProgress(progress);
        onScrollProgressRef.current?.(progress <= 0.001 ? 0 : progress);
      });

      window.setTimeout(() => {
        refreshDark7V31ScrollTriggers(true);
        const progress =
          getDARK7_V31ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
        applyScrollProgress(progress);
        onScrollProgressRef.current?.(progress <= 0.001 ? 0 : progress);
        if (embeddedScroll) {
          notifyHeroPinReady();
