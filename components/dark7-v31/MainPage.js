...
import {
  initDark7V31LenisScroll,
  destroyDark7V31LenisScroll,
  refreshDark7V31ScrollTriggers,
  markDark7V31ScrollLayoutSettled,
  hasActiveDark7V31Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V31Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V31ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V31ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V31ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V31LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v31-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
