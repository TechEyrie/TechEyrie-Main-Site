...
export default function TestimonialsSection({ theme, sharedBackground = false }) {
  ...
  useLayoutEffect(() => {
    ...
    const setup = () => {
      ...
      tween?.kill();
      ScrollTrigger.getById("dark7-v31-testimonials-heading-opacity")?.kill();
      ...
      tween = gsap.fromTo(
        ...
        { autoAlpha: 1 },
        {
          ...
          scrollTrigger: Dark7V31ScrollTrigger({
            id: "dark7-v31-testimonials-heading-opacity",
            trigger: cards,
            start: "top 12%",
            end: "top -35%",
            scrub: 0.55,
  ...
  return (
    <div
      ref={sectionRef}
      className={`dark7-v31-testimonials relative min-h-[150vh] -mb-px ${textColor} selection:bg-indigo-500/30 transition-colors duration-500`}
      style={bgColorStyle}
    >
