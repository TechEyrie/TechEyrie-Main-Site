...
import {
  initDark7V32LenisScroll,
  destroyDark7V32LenisScroll,
  refreshDark7V32ScrollTriggers,
  markDark7V32ScrollLayoutSettled,
  hasActiveDark7V32Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V32Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V32ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V32ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V32ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V32LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v32-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
