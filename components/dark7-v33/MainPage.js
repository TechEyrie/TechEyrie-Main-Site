...
import {
  initDark7V33LenisScroll,
  destroyDark7V33LenisScroll,
  refreshDark7V33ScrollTriggers,
  markDark7V33ScrollLayoutSettled,
  hasActiveDark7V33Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V33Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V33ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V33ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V33ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V33LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v33-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
