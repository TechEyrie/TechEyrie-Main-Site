...
import {
  initDark7V34LenisScroll,
  destroyDark7V34LenisScroll,
  refreshDark7V34ScrollTriggers,
  markDark7V34ScrollLayoutSettled,
  hasActiveDark7V34Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V34Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V34ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V34ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V34ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V34LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v34-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
