...
import {
  initDark7V36LenisScroll,
  destroyDark7V36LenisScroll,
  refreshDark7V36ScrollTriggers,
  markDark7V36ScrollLayoutSettled,
  hasActiveDark7V36Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V36Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V36ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V36ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V36ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V36LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v36-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
