...
import {
  initDark7V37LenisScroll,
  destroyDark7V37LenisScroll,
  refreshDark7V37ScrollTriggers,
  markDark7V37ScrollLayoutSettled,
  hasActiveDark7V37Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V37Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V37ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V37ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V37ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V37LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v37-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
