...
import {
  initDark7V38LenisScroll,
  destroyDark7V38LenisScroll,
  refreshDark7V38ScrollTriggers,
  markDark7V38ScrollLayoutSettled,
  hasActiveDark7V38Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V38Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V38ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V38ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V38ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V38LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v38-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
