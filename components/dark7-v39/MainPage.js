...
import {
  initDark7V39LenisScroll,
  destroyDark7V39LenisScroll,
  refreshDark7V39ScrollTriggers,
  markDark7V39ScrollLayoutSettled,
  hasActiveDark7V39Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V39Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V39ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V39ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V39ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V39LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v39-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
