...
export default function ServicesSection({ theme = "light", sharedBackground = false }) {
  ...
  return (
    <section
      className="dark7-v4-cards-services relative py-16 sm:py-20 md:py-24 lg:py-32 overflow-hidden transition-colors duration-500"
      style={bgStyle}
    >
      ...
      <div className="relative z-[2] max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8">
        {/* Section Title */}
        <h2
          className={`cards-services-heading font-italiana font-light text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] xl:text-[64px] 2xl:text-[72px] 3xl:text-[80px] tracking-[0.01em] mb-8 sm:mb-12 md:mb-16 transition-colors duration-500 ${
