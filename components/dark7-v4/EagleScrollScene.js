...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    // ── EAGLE POSITION (dark7-v4 / three3 / three4 hero) ──────────────────
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v4). First value = camera X.
      ...
      ScrollTrigger.getById(DARK7_V4_HERO_PIN_ID)?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          ...
          scrollTrigger: dark7V4ScrollTrigger({
            id: embeddedScroll ? DARK7_V4_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V4ScrollTriggers();
        const progress =
          getDark7V4ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
