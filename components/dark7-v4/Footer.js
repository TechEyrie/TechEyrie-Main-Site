...
export default function Footer({ theme = 'light' }) {
  ...
  const footerBgStyle =
    theme === 'dark'
      ? dark7GradientSurfaceStyle(DARK7_GRADIENTS.footer, '#122218')
  ...
  return (
    <>
      ...
      <footer
        className="dark5-footer dark7-v4-footer pt-3 sm:pt-4 md:pt-5 pb-4 sm:pb-5 md:pb-6 px-4 sm:px-5 md:px-6 lg:px-8"
        style={footerBgStyle}
      >
        <div
