...
import {
  initDark7V4LenisScroll,
  destroyDark7V4LenisScroll,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V4ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V4ScrollTriggers(true), 500),
      window.setTimeout(() => refreshDark7V4ScrollTriggers(true), 1200),
    ];

    const onLoad = () => refreshDark7V4ScrollTriggers(true);
    ...
    return () => {
      ...
      destroyDark7V4LenisScroll(lenis);
      lenis.destroy();
