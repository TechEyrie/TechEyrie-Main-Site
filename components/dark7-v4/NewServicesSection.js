...
const SERVICES = [
  {
    ...
    description: "Transforming critical business processes through AI-enabled workflows and intelligent agents by delivering efficient work and reducing manual working so your team can focus on creativity, growth and strategy.",
...
export default function NewServicesSection({ theme = "light", sharedBackground = false }) {
  ...
  const bodyColor = surfaceIsLight
    ...
    : theme === "dark"
      ? "text-[#d0d0d0]"
      : "text-[#212121]";
  const labelColor = surfaceIsLight
    ? "text-[#212121]"
    : theme === "dark"
      ? "text-[#f3f3f3]"
      : "text-[#212121]";
  ...
  const triggerElectricalAnimation = useCallback(() => {
    ...
    const originalColor = surfaceIsLight ? "#111111" : theme === "dark" ? "#f3f3f3" : "#111111";
  ...
  return (
    <>
      <section
        ref={sectionRef}
        className="dark7-v4-new-services relative overflow-hidden pt-12 sm:pt-16 md:pt-24 lg:pt-40 pb-12 sm:pb-16 md:pb-24 lg:pb-40 bg-transition"
        style={
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-[1800px] px-4 sm:px-6 md:px-8">
          ...
          <div className="mb-6 sm:mb-8 flex items-center gap-2 sm:gap-3">
            ...
            <span
              className={`font-merriweather text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] font-semibold tracking-[0.16em] uppercase text-transition new-services-surface-text ${labelColor}`}
            >
              Our services
            </span>
          </div>
          ...
          <div className="grid lg:grid-cols-[25%_1fr] gap-8 lg:gap-40 mb-8 sm:mb-10 md:mb-12 lg:mb-14">
            ...
            <div ref={titleContainerRef} className="lg:-mt-16 xl:-mt-16 2xl:-mt-16">
              <h2 className="leading-[1.08] sm:leading-[1.05] tracking-[0.01em]">
                <div
                  className={`new-services-title-line text-[26px] sm:text-[34px] md:text-[42px] lg:text-[60px] xl:text-[70px] 2xl:text-[82px] text-transition ${headingColor}`}
                >
          ...
          <div className="mb-6 sm:mb-8 space-y-4 lg:hidden">
            <p
              className={`font-merriweather text-[14px] sm:text-[15px] font-normal leading-relaxed text-transition new-services-surface-body ${bodyColor}`}
            >
          ...
          <div className="flex flex-col gap-8 lg:grid lg:grid-cols-[25%_1fr] lg:gap-40">
            ...
            <div className="flex flex-col w-full min-w-0">
              <div className="hidden lg:block mb-6 sm:mb-8 space-y-4 lg:max-w-[70%]">
                <p
                  className={`font-merriweather text-[13px] xl:text-[15px] font-normal leading-relaxed text-transition new-services-surface-body ${bodyColor}`}
                >
                  Growth is thrilling until it meets complexity. Tools expand, processes slow down, and visibility slips. Once felt controllable turns into uncontrollable.
                </p>
                <p
                ...
                {SERVICES.map((service, index) => {
                  ...
                  return (
                    <article
                      ...
                      className={`
                        service-card new-services-card group relative flex flex-col
                    ...
                    >
                      <div className={`${!isDesktop ? "flex items-start justify-between gap-3" : ""}`}>
                        <h3
                          className={`new-services-card-title font-merriweather font-normal tracking-tight leading-snug text-black text-transition ${
                            isDesktop
                      ...
                      >
                        <p
                          className={`new-services-card-body font-merriweather font-normal leading-relaxed text-black text-transition ${
                            isDesktop
