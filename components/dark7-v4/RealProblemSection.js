    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-[1800px] px-4 sm:px-6 md:px-8 lg:px-10 flex flex-col justify-center min-h-full">
          ...
          <div className="mb-6 flex items-center gap-2 sm:mb-7 sm:gap-3 md:mb-8 lg:mb-10">
            <Image
            ...
            />
            <span
              className="font-playfair text-base font-normal text-black sm:text-lg md:text-xl lg:text-2xl"
              style={{ color: "#000000" }}
            >
              The real problem is
            </span>
          ...
          <div className="grid gap-8 sm:gap-10 md:gap-12 lg:grid-cols-[1.3fr_1fr] lg:gap-16">
            ...
            <div className="flex flex-col gap-5 sm:gap-6 md:gap-7 lg:max-w-[600px] mt-4 sm:mt-6 md:mt-8 lg:mt-16">
              ...
              <Link
                href="/services"
                className="real-problem-cta mt-2 inline-flex items-center justify-center self-start px-5 py-2.5 font-merriweather text-[16px] font-light tracking-tight text-black transition-colors duration-300 sm:mt-3 md:px-6 md:py-3 md:text-[18px]"
                style={{
                  backgroundColor: "#162D241A",
                  borderRadius: "10px",
                }}
              >
                Our services
