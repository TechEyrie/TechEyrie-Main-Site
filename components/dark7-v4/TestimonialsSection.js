...
export default function TestimonialsSection({ theme, sharedBackground = false }) {
  ...
  return (
    <div
      className={`dark7-v4-testimonials relative min-h-[150vh] -mb-px ${textColor} selection:bg-indigo-500/30 transition-colors duration-500`}
      style={bgColorStyle}
    >
        ...
        <div className="relative z-[2]">
            {/* Sticky heading — cards scroll over it; do not add overflow-hidden on ancestors */}
