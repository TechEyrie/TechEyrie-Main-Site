...
import {
  initDark7V40LenisScroll,
  destroyDark7V40LenisScroll,
  refreshDark7V40ScrollTriggers,
  markDark7V40ScrollLayoutSettled,
  hasActiveDark7V40Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V40Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V40ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V40ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V40ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V40LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v40-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
