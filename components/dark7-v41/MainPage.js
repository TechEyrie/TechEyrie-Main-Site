...
import {
  initDark7V41LenisScroll,
  destroyDark7V41LenisScroll,
  refreshDark7V41ScrollTriggers,
  markDark7V41ScrollLayoutSettled,
  hasActiveDark7V41Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V41Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V41ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V41ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V41ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V41LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v41-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
