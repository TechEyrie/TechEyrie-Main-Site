...
import {
  initDark7V42LenisScroll,
  destroyDark7V42LenisScroll,
  refreshDark7V42ScrollTriggers,
  markDark7V42ScrollLayoutSettled,
  hasActiveDark7V42Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V42Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V42ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V42ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V42ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V42LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v42-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
