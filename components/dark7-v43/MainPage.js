...
import {
  initDark7V43LenisScroll,
  destroyDark7V43LenisScroll,
  refreshDark7V43ScrollTriggers,
  markDark7V43ScrollLayoutSettled,
  hasActiveDark7V43Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V43Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V43ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V43ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V43ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V43LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v43-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
