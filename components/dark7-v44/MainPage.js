...
import {
  initDark7V44LenisScroll,
  destroyDark7V44LenisScroll,
  refreshDark7V44ScrollTriggers,
  markDark7V44ScrollLayoutSettled,
  hasActiveDark7V44Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V44Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V44ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V44ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V44ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V44LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v44-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
