...
import {
  initDark7V45LenisScroll,
  destroyDark7V45LenisScroll,
  refreshDark7V45ScrollTriggers,
  markDark7V45ScrollLayoutSettled,
  hasActiveDark7V45Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V45Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V45ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V45ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V45ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V45LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v45-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
