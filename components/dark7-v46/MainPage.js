...
import {
  initDark7V46LenisScroll,
  destroyDark7V46LenisScroll,
  refreshDark7V46ScrollTriggers,
  markDark7V46ScrollLayoutSettled,
  hasActiveDark7V46Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V46Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V46ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V46ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V46ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V46LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v46-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
