...
const SERVICES_WING_ID = "dark7-v46-services-right-wing";

/**
 * ═══════════════════════════════════════════════════════════════════════════
 * SERVICES LEFT-WING TUNING (v12 — inverse of v11)
 * File: components/dark7-v46/ServicesRightWingScene.js
 * Page: /dark7-v46  →  New Services section (left side)
 *
...
export default function ServicesRightWingScene({ sectionRef, className = "" }) {
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(section) {
      ...
      requestAnimationFrame(() => refreshDark7V46ScrollTriggers());
      window.setTimeout(() => refreshDark7V46ScrollTriggers(true), 400);
    }
