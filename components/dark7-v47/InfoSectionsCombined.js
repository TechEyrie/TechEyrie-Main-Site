...
export default function InfoSectionsCombined({ theme = "light", sharedBackground = false }) {
  ...
  }, [theme, orbDefs, sharedBackground]);
      ...
      {theme === "dark" && !sharedBackground && (
        <>
          ...
          <div
            ...
            style={{
              ...
              backgroundImage: `
                conic-gradient(
                  from 0deg at 50% 55%,
                  rgba(116,245,161,0) 0%,
                  rgba(116,245,161,0.38) 18%,
                  rgba(0,81,96,0.30) 42%,
                  rgba(116,245,161,0) 72%,
                  rgba(22,45,36,0) 100%
                ),
                radial-gradient(
                  ellipse at 50% 50%,
                  rgba(116,245,161,0.22) 0%,
          ...
          {orbDefs.map((def, i) => (
            <div
              ...
              style={{
                ...
                transform: "translate(-50%, -50%)",
                backgroundImage:
                  "radial-gradient(circle at center, rgba(116,245,161,0.65) 0%, rgba(0,81,96,0.28) 35%, rgba(22,45,36,0) 72%)",
                opacity: 0.02,
                filter: "blur(18px)",
                boxShadow: "0 0 120px rgba(116,245,161,0.10)",
              }}
            />
          ))}
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(61, 63, 42, 0.85) 0%, rgba(61, 63, 42, 0) 100%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(246, 242, 238, 0.85) 0%, rgba(246, 242, 238, 0) 100%)",
            }}
          />
        </>
      )}
