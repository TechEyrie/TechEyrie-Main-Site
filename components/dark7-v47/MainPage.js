...
import {
  initDark7V47LenisScroll,
  destroyDark7V47LenisScroll,
  refreshDark7V47ScrollTriggers,
  markDark7V47ScrollLayoutSettled,
  hasActiveDark7V47Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V47Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V47ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V47ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V47ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V47LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v47-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
