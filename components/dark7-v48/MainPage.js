...
import {
  initDark7V48LenisScroll,
  destroyDark7V48LenisScroll,
  refreshDark7V48ScrollTriggers,
  markDark7V48ScrollLayoutSettled,
  hasActiveDark7V48Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V48Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V48ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V48ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V48ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V48LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v48-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
