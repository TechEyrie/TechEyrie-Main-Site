...
/**
 * Airvoir bird tuning — edit these values, then hard-refresh `/dark7-v48`.
 * File: components/dark7-v48/AirvoirDragonScene.js
 *
...
const FLIGHT_START = {
  ...
  scale: 1.18,
  // Yaw — turn left / right around vertical axis (radians). p*0.5 ˜ side view; higher ˜ more “from the right”
  rotY: Math.PI * 0.72,
