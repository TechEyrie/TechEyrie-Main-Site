...
import {
  initDark7V49LenisScroll,
  destroyDark7V49LenisScroll,
  refreshDark7V49ScrollTriggers,
  markDark7V49ScrollLayoutSettled,
  hasActiveDark7V49Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V49Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V49ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V49ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V49ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V49LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v49-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
