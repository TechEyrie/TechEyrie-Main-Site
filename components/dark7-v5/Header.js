  ...
  return (
    <>
      <style jsx global>{`
        ...
        .dropdown-card:hover .dark7-v5-header-arrow-btn {
            ...
            >
                ...
                {navItems.map((item) => (
                  ...
                  >
                    {item.href ? (
                      <Link
                        href={item.href}
                        className="dark7-v5-header-nav-link flex h-full items-center gap-1.5 rounded-[8px] px-3.5 lg:px-4 font-merriweather text-[13px] font-light leading-none tracking-[0.04em] transition-all duration-200 cursor-pointer"
                        style={{
              ...
              <div className="flex h-full flex-shrink-0 items-center pl-2">
                ...
                <button
                  ...
                  className="dark7-v5-header-nav-link group flex h-full cursor-pointer items-center gap-2"
                >
                  <span
