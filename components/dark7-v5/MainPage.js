...
import {
  initDark7V5LenisScroll,
  destroyDark7V5LenisScroll,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V5ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V5ScrollTriggers(true), 500),
      window.setTimeout(() => refreshDark7V5ScrollTriggers(true), 1200),
    ];

    const onLoad = () => refreshDark7V5ScrollTriggers(true);
    ...
    return () => {
      ...
      destroyDark7V5LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v5-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
