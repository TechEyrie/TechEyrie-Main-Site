...
export default function PerfectEagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v5). First value = camera X.
      ...
      ScrollTrigger.getById(DARK7_V5_HERO_PIN_ID)?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          ...
          scrollTrigger: dark7V5ScrollTrigger({
            id: embeddedScroll ? DARK7_V5_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V5ScrollTriggers();
        const progress =
          getDark7V5ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
