...
import {
  initDark7V50LenisScroll,
  destroyDark7V50LenisScroll,
  refreshDark7V50ScrollTriggers,
  markDark7V50ScrollLayoutSettled,
  hasActiveDark7V50Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V50Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V50ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V50ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V50ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V50LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v50-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
