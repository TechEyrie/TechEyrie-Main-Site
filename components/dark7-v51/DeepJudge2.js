...
import { Dark7V51ScrollTrigger, refreshDark7V51ScrollTriggers, subscribeAfterScrollLayout } from "./lenisScrollTrigger";
import {
  DARK7_GRADIENTS,
...
export default function DeepJudge2({ theme }) {
  ...
  // Light cream surface on dark7-v51 (theme prop stays "dark" for page shell)
    ...
    let ctx = gsap.context(() => {
      ...
      mm.add("(min-width: 1024px)", () => {
        ...
        const build = () => {
          ...
          ScrollTrigger.getById("dark7-v51-deep-judge")?.kill();

          const tl = gsap.timeline({
            scrollTrigger: Dark7V51ScrollTrigger({
              id: "dark7-v51-deep-judge",
  ...
  return (
    <main
      ref={containerRef}
      style={bgStyle}
      className="dark7-v51-deep-judge relative min-h-screen overflow-x-hidden transition-colors duration-500 isolate"
    >
      <div
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-[25] px-4 sm:px-6">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <p ref={description2Ref} className="deep-judge-phase2-text font-merriweather font-light text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[15px] text-[#F7F3F0] opacity-0 max-w-3xl px-6 leading-relaxed transition-colors duration-500 z-[26] text-center mt-8 sm:mt-10 md:mt-12">
      ...
      <section className="relative z-10 w-full px-4 sm:px-6 md:px-8 py-14 sm:py-20 md:py-24 lg:hidden">
          <div className="mx-auto flex max-w-2xl flex-col gap-16 sm:gap-20 md:gap-24 lg:max-w-3xl">
            ...
            <div className={`space-y-6 sm:space-y-8 border-t pt-14 sm:pt-16 md:pt-20 text-center ${surfaceIsLight ? "border-black/10" : isDark ? "border-white/10" : "border-black/10"}`}>
              ...
              <p className="deep-judge-phase2-text font-merriweather font-light text-[14px] sm:text-[15px] text-[#F7F3F0] leading-relaxed px-1">
