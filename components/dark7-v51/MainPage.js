...
import {
  initDark7V51LenisScroll,
  destroyDark7V51LenisScroll,
  refreshDark7V51ScrollTriggers,
  markDark7V51ScrollLayoutSettled,
  hasActiveDark7V51Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V51Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V51ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V51ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V51ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V51LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v51-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
