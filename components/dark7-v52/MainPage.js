...
import {
  initDark7V52LenisScroll,
  destroyDark7V52LenisScroll,
  refreshDark7V52ScrollTriggers,
  markDark7V52ScrollLayoutSettled,
  hasActiveDark7V52Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V52Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V52ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V52ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V52ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V52LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v52-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
