...
import {
  initDark7V53LenisScroll,
  destroyDark7V53LenisScroll,
  refreshDark7V53ScrollTriggers,
  markDark7V53ScrollLayoutSettled,
  hasActiveDark7V53Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V53Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V53ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V53ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V53ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V53LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v53-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
