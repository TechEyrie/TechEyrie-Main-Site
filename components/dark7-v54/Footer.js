  ...
  return (
    <>
      <style jsx global>{`
        ...
        .dark7-v54-footer .dark5-footer-card {
          background-color: transparent !important;
          border-color: rgba(247, 243, 240, 0.2) !important;
          box-shadow: 0 24px 40px -12px rgba(0, 0, 0, 0.35) !important;
        }

        .dark7-v54-footer .dark5-footer-text,
        .dark7-v54-footer .dark5-footer-subtext:not(.blogs-section-description),
        .dark7-v54-footer .footer-link-underline:not(.blogs-section-description),
        .dark7-v54-footer .footer-link-underline:not(.blogs-section-description):hover,
        .dark7-v54-footer p,
        .dark7-v54-footer span,
        .dark7-v54-footer a:not(.social-icon-animate):not(.blogs-section-description) {
          color: #f7f3f0 !important;
        }

        .dark7-v54-footer .footer-section-label {
          letter-spacing: 0.12em !important;
        }

        .dark7-v54-footer .dark5-footer-border {
          border-color: rgba(247, 243, 240, 0.2) !important;
        }
        ...
        .dark7-v54-footer .footer-link-underline::after {
        ...
        .dark7-v54-footer .social-icon-animate {
          background-color: #162d24 !important;
          color: #f7f3f0 !important;
        }

        .dark7-v54-footer .social-icon-animate:hover {
      ...
      <footer
        className={`dark5-footer dark7-v54-footer relative overflow-hidden pt-3 sm:pt-4 md:pt-5 pb-4 sm:pb-5 md:pb-6 px-4 sm:px-5 md:px-6 lg:px-8 ${
          theme === 'dark' ? '-mt-[2px]' : ''
        }`}
        style={footerBgStyle}
      >
...
function FooterLink({ href, children, theme = 'light' }) {
  ...
  return (
    <Link
      href={href}
      className="blogs-section-description footer-link-underline dark7-v54-footer-menu-link block font-merriweather font-light leading-snug tracking-normal transition-colors whitespace-nowrap"
      style={{ color: textColor }}
    >
      {children}
    </Link>
