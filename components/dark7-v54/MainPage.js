...
import {
  initDark7V54LenisScroll,
  destroyDark7V54LenisScroll,
  refreshDark7V54ScrollTriggers,
  markDark7V54ScrollLayoutSettled,
  hasActiveDark7V54Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V54Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V54ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V54ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V54ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V54LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v54-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
