...
import {
  initDark7V55LenisScroll,
  destroyDark7V55LenisScroll,
  refreshDark7V55ScrollTriggers,
  markDark7V55ScrollLayoutSettled,
  hasActiveDark7V55Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V55Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V55ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V55ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V55ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V55LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v55-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
