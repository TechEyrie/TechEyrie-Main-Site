...
import { Dark7V56ScrollTrigger, refreshDark7V56ScrollTriggers, subscribeAfterScrollLayout } from "./lenisScrollTrigger";
import {
  DARK7_GRADIENTS,
...
export default function DeepJudge2({ theme }) {
  ...
  // Light cream surface on dark7-v56 (theme prop stays "dark" for page shell)
    ...
    let ctx = gsap.context(() => {
      ...
      mm.add("(min-width: 1024px)", () => {
        ...
        const build = () => {
          ...
          ScrollTrigger.getById("dark7-v56-deep-judge")?.kill();

          const tl = gsap.timeline({
            scrollTrigger: Dark7V56ScrollTrigger({
              id: "dark7-v56-deep-judge",
  ...
  return (
    <main
      ref={containerRef}
      style={bgStyle}
      className="dark7-v56-deep-judge relative min-h-screen overflow-x-hidden transition-colors duration-500 isolate"
    >
      <div
