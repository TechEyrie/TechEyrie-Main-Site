...
import {
  initDark7V56LenisScroll,
  destroyDark7V56LenisScroll,
  refreshDark7V56ScrollTriggers,
  markDark7V56ScrollLayoutSettled,
  hasActiveDark7V56Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V56Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V56ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V56ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V56ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V56LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v56-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
