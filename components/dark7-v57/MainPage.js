...
import {
  initDark7V57LenisScroll,
  destroyDark7V57LenisScroll,
  refreshDark7V57ScrollTriggers,
  markDark7V57ScrollLayoutSettled,
  hasActiveDark7V57Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V57Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V57ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V57ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V57ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V57LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v57-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
