...
import {
  initDark7V58LenisScroll,
  destroyDark7V58LenisScroll,
  refreshDark7V58ScrollTriggers,
  markDark7V58ScrollLayoutSettled,
  hasActiveDark7V58Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V58Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V58ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V58ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V58ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V58LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v58-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
