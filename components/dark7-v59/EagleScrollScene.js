...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v59).
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          progress: 1,
          ease: "none",
          scrollTrigger: Dark7V59ScrollTrigger({
            id: embeddedScroll ? DARK7_V59_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V59ScrollTriggers();
        const progress =
          getDark7V59ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
