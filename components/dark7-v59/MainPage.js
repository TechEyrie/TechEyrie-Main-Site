...
import {
  initDark7V59LenisScroll,
  destroyDark7V59LenisScroll,
  refreshDark7V59ScrollTriggers,
  markDark7V59ScrollLayoutSettled,
  hasActiveDark7V59Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V59Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V59ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V59ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V59ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V59LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v59-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
