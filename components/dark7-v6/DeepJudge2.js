...
import { Dark7V6ScrollTrigger, refreshDark7V6ScrollTriggers, subscribeAfterScrollLayout } from "./lenisScrollTrigger";
import {
  DARK7_GRADIENTS,
...
export default function DeepJudge2({ theme }) {
  ...
  // Light cream surface on dark7-v6 (theme prop stays "dark" for page shell)
    ...
    let ctx = gsap.context(() => {
      ...
      mm.add("(min-width: 1024px)", () => {
        ...
        const build = () => {
          ...
          ScrollTrigger.getById("dark7-v6-deep-judge")?.kill();

          const tl = gsap.timeline({
            scrollTrigger: Dark7V6ScrollTrigger({
              id: "dark7-v6-deep-judge",
