...
export default function EagleScrollScene({
  ...
  useLayoutEffect(() => {
    ...
    function createScrollAnimation(triggerEl) {
      ...
      // Initial camera for embedded hero (dark7-v6). First value = camera X.
      ...
      ScrollTrigger.getById(DARK7_V6_HERO_PIN_ID)?.kill();
      ...
      gsapCtx = gsap.context(() => {
        ...
        scrollTween = gsap.to(state, {
          ...
          scrollTrigger: Dark7V6ScrollTrigger({
            id: embeddedScroll ? DARK7_V6_HERO_PIN_ID : "eagle-scroll-scene",
            trigger: triggerEl,
            start: "top top",
      ...
      requestAnimationFrame(() => {
        refreshDark7V6ScrollTriggers();
        const progress =
          getDark7V6ScrollTop() < 8 ? 0 : (scrollTween?.scrollTrigger?.progress ?? 0);
