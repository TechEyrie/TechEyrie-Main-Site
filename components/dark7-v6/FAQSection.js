  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1500px] px-4 sm:px-6 md:px-8">
        ...
        <p className="faq-section-description mx-auto mb-10 sm:mb-14 md:mb-16 lg:mb-20 xl:mb-24 max-w-3xl text-center font-merriweather text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[15px] font-light leading-relaxed tracking-tight text-[#F7F3F0]">
