...
const FOOTER_CARD_BG = 'rgba(247, 243, 240, 0.2)';
...
export default function Footer({ theme = 'light' }) {
  ...
  const footerBgStyle =
    theme === 'dark'
      ? {
          ...dark7GradientSurfaceStyle(DARK7_GRADIENTS.footer, DARK7_FOOTER_END),
          backgroundColor: DARK7_FOOTER_END,
        }
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="dark5-footer-card relative z-[1] mx-auto max-w-[1920px] rounded-lg sm:rounded-xl md:rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.35)] px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 pt-4 sm:pt-5 md:pt-6 pb-4 sm:pb-5 md:pb-6"
          style={{
