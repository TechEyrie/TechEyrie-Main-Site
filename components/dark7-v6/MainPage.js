...
import {
  initDark7V6LenisScroll,
  destroyDark7V6LenisScroll,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V6ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V6ScrollTriggers(true), 500),
      window.setTimeout(() => refreshDark7V6ScrollTriggers(true), 1200),
    ];

    const onLoad = () => refreshDark7V6ScrollTriggers(true);
    ...
    return () => {
      ...
      destroyDark7V6LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v6-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
