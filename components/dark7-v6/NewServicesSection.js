...
function ServiceArrowLink({ href, label, className = "", onClick }) {
  return (
    <Link
      href={href}
      onClick={onClick}
      className={`relative flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center overflow-hidden rounded-[4px] dark7-v6-header-arrow-btn transition-all duration-500 ease-out group-hover:scale-110 group-hover:-translate-y-[1px] flex-shrink-0 ${className}`}
      aria-label={label}
    >
...
export default function NewServicesSection({ theme = "light", sharedBackground = false }) {
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      .new-services-card:hover .dark7-v6-header-arrow-btn {
  ...
  return (
    <>
      <section
        ref={sectionRef}
        className="dark7-v6-new-services relative overflow-hidden pt-12 sm:pt-16 md:pt-24 lg:pt-40 pb-12 sm:pb-16 md:pb-24 lg:pb-40 bg-transition"
        style={
        ...
        <div className="relative z-10 mx-auto max-w-[1800px] px-4 sm:px-6 md:px-8">
          ...
          <div className="new-services-fade mb-6 flex items-center gap-2 sm:mb-8 sm:gap-3">
            <Image
              ...
              aria-hidden
            />
            <span className="dark7-v6-section-eyebrow font-playfair font-normal text-[#162D24]">
              Our services
            </span>
          </div>
          ...
          <div className="grid lg:grid-cols-[25%_1fr] gap-8 lg:gap-40 mb-8">
            ...
            <div ref={titleContainerRef} className="lg:-mt-16 xl:-mt-16 2xl:-mt-16">
              <h2 className="leading-[1.08] sm:leading-[1.05] tracking-[0.01em]">
                <div className={`new-services-fade new-services-title-line text-transition ${headingColor}`}>
