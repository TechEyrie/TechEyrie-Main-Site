...
export default function FAQSection({ theme = 'light', sharedBackground = false }) {
  ...
  return (
    <section
      ref={sectionRef}
      className="dark7-v60-faq relative overflow-hidden py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32"
      style={bgStyle}
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1500px] px-4 sm:px-6 md:px-8">
        ...
        <div className="mb-6 sm:mb-8 md:mb-10 flex items-center justify-center gap-2 sm:gap-3">
          <Image
            ...
            aria-hidden
          />
          <span className="faq-section-eyebrow dark7-v60-section-eyebrow font-playfair font-normal text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] tracking-[0.16em] uppercase text-[#F7F3F0]">
            FAQ
          </span>
        </div>
