...
import {
  initDark7V60LenisScroll,
  destroyDark7V60LenisScroll,
  refreshDark7V60ScrollTriggers,
  markDark7V60ScrollLayoutSettled,
  hasActiveDark7V60Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V60Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V60ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V60ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V60ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V60LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v60-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
