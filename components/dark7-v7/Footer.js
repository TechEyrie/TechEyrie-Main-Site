  ...
  return (
    <>
      <style jsx global>{`
        ...
        .dark7-v7-footer .dark5-footer-card {
        ...
        .dark7-v7-footer .dark5-footer-border {
          border-color: rgba(247, 243, 240, 0.2) !important;
        }
        ...
        .dark7-v7-footer .footer-link-underline::after {
        ...
        .dark7-v7-footer .social-icon-animate {
          background-color: #162d24 !important;
          color: #f7f3f0 !important;
        }

        .dark7-v7-footer .social-icon-animate:hover {
      ...
      <footer
        className={`dark5-footer dark7-v7-footer relative overflow-hidden pt-3 sm:pt-4 md:pt-5 pb-4 sm:pb-5 md:pb-6 px-4 sm:px-5 md:px-6 lg:px-8 ${
          theme === 'dark' ? '-mt-[2px]' : ''
        }`}
        style={footerBgStyle}
      >
