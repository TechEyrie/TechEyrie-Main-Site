...
import {
  initDark7V8LenisScroll,
  destroyDark7V8LenisScroll,
  refreshDark7V8ScrollTriggers,
  markDark7V8ScrollLayoutSettled,
  hasActiveDark7V8Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V8Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V8ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V8ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V8ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V8LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v8-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
