...
import {
  initDark7V9LenisScroll,
  destroyDark7V9LenisScroll,
  refreshDark7V9ScrollTriggers,
  markDark7V9ScrollLayoutSettled,
  hasActiveDark7V9Pin,
...
const MainPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    const onWindowResize = () => {
      if (hasActiveDark7V9Pin() || lenis.isScrolling) return;
      lenis.resize();
      refreshDark7V9ScrollTriggers(false);
    };
    ...
    const refreshTimers = [
      window.setTimeout(() => refreshDark7V9ScrollTriggers(true), 100),
      window.setTimeout(() => refreshDark7V9ScrollTriggers(true), 500),
      window.setTimeout(() => {
    ...
    return () => {
      ...
      destroyDark7V9LenisScroll(lenis);
      lenis.destroy();
  ...
  return (
    <div className="dark2-page dark7-v9-page" style={{ position: "relative", zIndex: 1 }} data-theme={theme}>
      <Header theme={theme} />
