...
import { LUX, dark77MainSurfaceStyle } from "./dark77LuxuryPalette";
  ...
  const services = [
    {
      ...
      bgColor: theme === "dark" ? LUX.bgElevated : "#111111",
      textColor: LUX.textPrimary,
      buttonBg: LUX.cream,
      buttonText: LUX.textOnCream,
      isLightCard: false,
    },
    {
      id: 1,
      ...
      tags: [],
      bgColor: LUX.creamWarm,
      textColor: LUX.textOnCream,
      buttonBg: LUX.bgElevated,
      buttonText: LUX.cream,
      isLightCard: true,
    },
    {
      id: 2,
      ...
      tags: [],
      bgColor: theme === "dark" ? LUX.bgCard : "#E5E5E5",
      textColor: theme === "dark" ? LUX.textPrimary : "#111111",
      buttonBg: LUX.cream,
      buttonText: LUX.textOnCream,
      isLightCard: false,
    },
  ...
  return (
    <section
      className={`relative py-16 sm:py-20 md:py-24 lg:py-32 overflow-hidden transition-colors duration-500 ${
        theme === "dark" && sharedBackground ? "cards-services-cream-band" : ""
      }`}
      style={bgStyle}
    >
      {theme === "dark" && !sharedBackground && (
        <>
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #1e3a2f 0%, rgba(30,58,46,0) 100%)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(26,36,32,0.45) 0%, rgba(26,36,32,0) 100%)",
            }}
          />
        </>
      )}
            ...
            >
              ...
              <div className="relative h-full flex flex-col">
                ...
                <div className="flex-1 flex flex-col px-5 sm:px-6 md:px-8 pb-5 sm:pb-6 md:pb-8">
                  ...
                  <button
                    type="button"
                    className="mt-auto group inline-flex items-center justify-between w-full rounded-full px-5 py-2.5 sm:px-6 sm:py-3 shadow-sm transition-transform duration-300 ease-out hover:scale-[1.05] hover:-translate-y-[1px] lux-cta-pill"
                    style={{ backgroundColor: LUX.cta }}
                  >
