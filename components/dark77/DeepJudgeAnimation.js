  ...
  const bgStyle = theme === "dark"
    ? {
        ...
        backgroundImage: `
          ...
          radial-gradient(
            ellipse at 60% 80%,
            rgba(107, 155, 122, 0.1) 0%,
            rgba(37, 70, 54, 0.4) 40%,
            rgba(17, 20, 19, 0.92) 100%
          )
        `,
      ...
      {theme === "dark" && (
        <>
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #1a3228 0%, rgba(26,50,40,0) 100%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, #1a3228 0%, rgba(26,50,40,0) 100%)",
            }}
          />
        </>
      )}
