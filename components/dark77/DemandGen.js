...
//                 <span className="pointer-events-none absolute -left-6 top-16 h-14 w-8 bg-[#E8DCC8]" />
//                 <span className="pointer-events-none absolute left-16 -bottom-6 h-10 w-24 bg-[#E8DCC8]" />
//               </div>
//             </div>
...
//                           <span className="mt-[3px] h-5 w-5 shrink-0 rounded-md bg-[#E8DCC8]" />
//                           <span
          ...
          <div className="grid items-start gap-8 sm:gap-10 md:gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1.7fr)]">
            ...
            <div ref={phoneWrapperRef} className="relative lg:sticky lg:top-28 mb-8 lg:mb-0">
              ...
              >
                ...
                <span className="pointer-events-none absolute -left-3 top-12 sm:-left-4 sm:top-14 md:-left-6 md:top-16 h-10 w-6 sm:h-12 sm:w-7 md:h-14 md:w-8 bg-[#E8DCC8]" />
                <span className="pointer-events-none absolute left-10 -bottom-3 sm:left-12 sm:-bottom-4 md:left-16 md:-bottom-6 h-6 w-16 sm:h-8 sm:w-20 md:h-10 md:w-24 bg-[#E8DCC8]" />
              </div>
            </div>
                    ...
                    <ul className="mt-3 sm:mt-4 md:mt-6 space-y-2 sm:space-y-3 md:space-y-4">
                      {block.results.map((item) => (
                        <li key={item} className="flex items-start gap-2 sm:gap-3">
                          <span className="mt-[3px] h-4 w-4 sm:h-5 sm:w-5 shrink-0 rounded-md bg-[#E8DCC8]" />
                          <span
