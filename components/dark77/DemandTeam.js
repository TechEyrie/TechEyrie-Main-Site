          ...
          <div className="relative z-10 flex items-center justify-center gap-10 md:gap-16 lg:gap-24">
            ...
            <div className="relative h-64 w-48 sm:h-80 sm:w-56 md:h-96 md:w-64 lg:h-[420px] lg:w-72">
              ...
              <div className="absolute bottom-4 left-1/2 z-20 -translate-x-1/2">
                ...
                >
                  Meet the team
                  <span className="flex h-7 w-7 items-center justify-center rounded bg-[#E8DCC8]">
...
function Tile({ label }) {
  return (
    <div className="flex h-20 w-28 items-center justify-center rounded-xl bg-[#E8DCC8] px-3 text-center shadow-xl md:h-24 md:w-36 lg:w-40 xl:w-44">
