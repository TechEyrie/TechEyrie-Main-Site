...
export default function Header({ theme = "light" }) {
  ...
  const cardBg = theme === "dark" ? "#2a5544" : lightColors.background;
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-4 md:px-8 gap-3">
          ...
          {/* Logo - Left Side */}
          <Link href="/dark77" className="flex flex-shrink-0 items-center">
          ...
          <div className="flex items-center gap-3">
            <div
              className="flex items-center justify-between gap-2 rounded-[14px] px-3 shadow-[0_10px_30px_rgba(0,0,0,0.15)] md:gap-4 md:px-5 lg:px-6 h-[45px] backdrop-blur-md"
              style={{
                backgroundColor: headerBg,
                border:
                  theme === "dark"
                    ? "1px solid rgba(250, 244, 234, 0.18)"
                    : "none",
              }}
            >
              {/* Desktop NAV */}
              ...
              <div className="hidden flex-shrink-0 items-center gap-3 lg:flex h-full">
                ...
                <button onClick={() => setContactPopupOpen(true)} className="group flex items-center gap-2 cursor-pointer">
                  ...
                  <span
                    className={`relative flex h-6 w-6 items-center justify-center overflow-hidden rounded-[4px] bg-[#E8DCC8] transition-colors duration-500 ${
                      theme === "dark"
                  ...
                  >
                    ...
                    <div className="flex justify-end mt-4">
                      <span className="inline-flex h-6 w-6 flex-shrink-0 items-center justify-center">
                        <span className="relative flex h-6 w-6 items-center justify-center overflow-hidden rounded-[4px] bg-[#E8DCC8] transition-all duration-500 ease-out group-hover:bg-black group-hover:scale-110 group-hover:-translate-y-[1px]">
                          <span className="absolute inset-0 flex items-center justify-center transition-all duration-500 ease-out group-hover:translate-x-2 group-hover:-translate-y-2 group-hover:opacity-0">
                            <svg
                              width="10"
                              height="10"
          ...
          >
            ...
            <div className="mt-6 space-y-3 border-t pt-4" style={{ borderColor: mobileBorder }}>
              ...
              >
                ...
                <span
                  className="flex h-7 w-7 items-center justify-center rounded-[4px] bg-[#E8DCC8] transition-transform duration-300 group-hover:scale-110"
                >
