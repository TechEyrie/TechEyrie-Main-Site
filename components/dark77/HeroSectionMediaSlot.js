    ...
    () =>
      theme === "dark"
        ? {
            ...
            background:
              "linear-gradient(135deg, #1e3a2f 0%, #2a5544 18%, #3a6b58 55%, #1e3a2f 100%)",
          }
      ...
      {theme === "dark" && !sharedBackground && (
        <>
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(45,82,68,0.9) 0%, rgba(45,82,68,0) 100%)",
            }}
          />
        </>
      )}
        ...
        {theme === "dark" && (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 135% 65% at 62% 96%, #263C27 0%, rgba(38,60,39,0.98) 30%, rgba(26,50,40,0.0) 88%)",
              }}
            />
          </div>
        )}
                      ...
                      <div className="card-inner-content relative w-full h-full overflow-hidden rounded-xl">
                        ...
                        >
                          <svg className="absolute bottom-0 left-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                            <path d="M 0 100 L 46 15 A 5 5 0 0 1 54 15 L 100 100 Z" fill="#E8DCC8" />
                          </svg>
                ...
                <div className="relative flex flex-col w-full" style={{ width: isDesktop ? `${portfolioCardWidth}px` : "85%" }}>
                  ...
                  >
                    ...
                    {!isDesktop && (
                      ...
                      >
                        <svg className="absolute bottom-0 left-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                          <path d="M 0 100 L 30 35 C 38 25, 44 20, 50 20 C 56 20, 62 25, 70 35 L 100 100 Z" fill="#E8DCC8" />
                        </svg>
