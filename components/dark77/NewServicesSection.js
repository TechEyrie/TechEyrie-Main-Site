  ...
  const bgStyle =
    theme === "dark"
      ? {
          ...
          background:
            "linear-gradient(to bottom, #1e3a2f 0%, #1e3a2f 18%, #3a6b58 45%, #2a5544 70%, #1e3a2f 100%)",
        }
          ...
          <>
            ...
            <div
              ...
              style={{
                ...
                background:
                  "linear-gradient(to bottom, rgba(45,82,68,0.9) 0%, rgba(45,82,68,0) 100%)",
              }}
            />
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, #1e3a2f 0%, rgba(30,58,46,0) 100%)",
              }}
            />
          </>
        )}
            ...
            <div className="relative w-full h-full">
              <div className="sticky top-8 h-full">
                <div className="relative w-full service-card h-full">
                  ...
                  <span className="pointer-events-none absolute left-3 top-3 sm:left-4 sm:top-4 md:left-6 md:top-6 h-8 w-6 sm:h-10 sm:w-7 md:h-12 md:w-8 bg-[#E8DCC8] z-10" />
                  <span className="pointer-events-none absolute left-12 top-20 sm:left-16 sm:top-24 md:left-20 md:top-32 h-6 w-4 sm:h-8 sm:w-5 md:h-10 md:w-6 bg-[#E8DCC8] z-10" />
                </div>
              </div>
            </div>
                    ...
                    >
                      ...
                      <div className="mt-2 sm:mt-3 flex items-end justify-between gap-3 sm:gap-4">
                        ...
                        <Link
                          ...
                          className={`relative flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-[6px] bg-[#E8DCC8] transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-1 flex-shrink-0 ${
                            theme === "dark"
