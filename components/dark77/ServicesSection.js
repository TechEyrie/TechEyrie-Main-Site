...
//               {/* Green accent blocks */}
//               <span className="pointer-events-none absolute left-6 top-6 h-12 w-8 bg-[#E8DCC8]" />
//               <span className="pointer-events-none absolute left-20 top-32 h-10 w-6 bg-[#E8DCC8]" />
//             </div>
...
//                           className={`relative flex h-10 w-10 items-center justify-center rounded-[6px] bg-[#E8DCC8] transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-1 ${
//                             theme === "dark"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-4 sm:mt-6 flex items-end justify-between gap-3 sm:gap-4">
                        ...
                        <Link
                          href={`/services/${service.id}`}
                          className={`relative flex h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 items-center justify-center rounded-[6px] bg-[#E8DCC8] transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-1 flex-shrink-0 ${
                            theme === "dark"
                              ? "group-hover:bg-white"
                              : "group-hover:bg-black"
                          }`}
