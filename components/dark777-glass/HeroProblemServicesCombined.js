...
import { glass7MainSurfaceStyle } from "./dark7PageSurface";
...
export default function HeroProblemServicesCombined({ theme = "light" }) {
  ...
  const bgStyle = useMemo(
    () => (theme === "dark" ? glass7MainSurfaceStyle : { backgroundColor: "#F9F7F0" }),
    [theme],
  );
  ...
  return (
    <main
      ref={wrapperRef}
      className="hero-problem-services-combined glass-hero-combined relative overflow-hidden transition-colors duration-500"
      style={bgStyle}
    >
      {theme === "dark" && (
        <>
          ...
          <div
            ...
            style={{
              ...
              background:
                "linear-gradient(to bottom, rgba(190,215,235,0.2) 0%, rgba(190,215,235,0) 100%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(20,40,32,0.95) 0%, rgba(22,45,36,0) 100%)",
            }}
          />
        </>
      )}
      ...
      <div className="relative z-10">
          ...
          <>
            ...
            <div
              ...
              style={{
                ...
                transform: "translate(-50%, -50%)",
                backgroundImage:
                  "radial-gradient(circle at center, rgba(212,175,95,0.55) 0%, rgba(190,215,235,0.2) 32%, rgba(22,45,36,0) 72%)",
                mixBlendMode: "screen",
                opacity: 0.12,
                filter: "blur(18px)",
              }}
        ...
        {/* 1) Glass hero — full scroll + portfolio morph */}
        <div
          ref={heroWrapRef}
          className="relative dark777-luxury-hero glass-hero-a min-h-[92vh] sm:min-h-[94vh] lg:min-h-[100vh]"
        >
          {theme === "dark" && (
            <>
              <div className="glass-hero-a-orb-warm pointer-events-none" aria-hidden />
              <div className="glass-hero-a-orb-cool pointer-events-none" aria-hidden />
              ...
              <div
                ...
                style={{
                  ...
                  transform: "translate(-50%, -50%)",
                  backgroundImage:
                    "radial-gradient(circle at center, rgba(212,175,95,0.22) 0%, rgba(212,175,95,0.45) 18%, rgba(180,210,230,0.18) 42%, rgba(22,45,36,0) 72%)",
                  mixBlendMode: "screen",
                  opacity: 0.38,
                  filter: "blur(18px)",
                }}
          ...
          <div className="relative z-[10]">
            <HeroSectionMediaSlot theme={theme} sharedBackground glassVariant="A" />
          </div>
        </div>
