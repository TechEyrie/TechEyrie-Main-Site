...
export default function HeroSectionMediaSlot({
  ...
  const triggerElectricalAnimation = useCallback(() => {
    ...
    const electricColor = theme === "dark" ? "#d4af37" : "#3BC972";
  ...
  useLayoutEffect(() => {
    if (heroOnly || !isDesktop || !heroCardsContainerRef.current || !portfolioSectionRef.current) return;
    ...
    return () => ctx.revert();
  }, [isDesktop, screenSize, mediaAssets, triggerElectricalAnimation, heroStackOffset, heroOnly]);
  ...
  return (
    ...
    >
      ...
      <section
        ref={heroSectionRef}
        className={`relative overflow-visible pt-32 md:pt-40 pb-0 dark777-luxury-hero-section${glassVariant ? ` glass-hero-media-${glassVariant.toLowerCase()}` : ""}`}
        style={{
          paddingBottom: heroOnly ? "3rem" : getBottomPadding(),
          zIndex: 2,
          marginBottom: "0",
        }}
      >
        {theme === "dark" && !glassVariant && (
          <>
            {/* Radial atmosphere only — no solid fill so particles stay visible */}
            <div
            ...
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse 135% 65% at 62% 96%, rgba(38,60,39,0.55) 0%, rgba(38,60,39,0.2) 35%, transparent 88%), radial-gradient(ellipse 120% 80% at 72% 8%, rgba(212,175,95,0.14) 0%, transparent 52%)",
                }}
              />
            </div>
          </>
        )}
        {theme === "dark" && glassVariant === "A" && (
          <div
            className="pointer-events-none absolute inset-0 z-0 overflow-hidden glass-hero-atmosphere-mask"
            aria-hidden
            style={heroFadeMaskStyle}
          >
            <div className="absolute inset-0 glass-hero-atmosphere-inner" />
          </div>
        )}
        {theme === "dark" && glassVariant === "C" && (
          <div
            className="pointer-events-none absolute inset-0 z-0 overflow-hidden glass-hero-c-atmosphere-mask"
            aria-hidden
            style={heroFadeMaskStyle}
          >
            <div className="absolute inset-0 glass-hero-c-atmosphere-inner" />
          </div>
        )}
        {theme === "dark" && !sharedBackground && (
          <div
        ...
        <div className="relative z-10 mx-auto max-w-[1800px] px-4 md:px-6 lg:px-10 min-h-0 flex flex-col justify-between pt-12">
          <div className="grid grid-cols-1 lg:grid-cols-[65%_35%] gap-8 lg:gap-12 xl:gap-16 items-start">
            <div className={`flex flex-col${glassVariant === "A" ? " glass-hero-frosted-panel" : ""}`}>
              <div className="max-w-full lg:max-w-[1600px] xl:max-w-[1800px]" ref={titleContainerRef}>
                <div className="hero-badge dark777-luxury-badge mb-10 flex items-center gap-3 mb-16">
                  <span
                    className={`inline-flex h-5 w-5 rounded-sm${glassVariant === "A" ? " glass-badge-gem-a" : " dark777-luxury-badge-gem"}`}
                  />
                  <span className={`font-merriweather text-[13px] md:text-[15px] font-semibold tracking-[0.2em] uppercase ${theme === "dark" ? "text-[#e8dcc8]" : "text-[#212121]"}`}>
                ...
                <h1 className="mb-4 font-italiana tracking-[-0.03em]">
                  ...
                  <span className={`hero-main-title-line block text-[32px] sm:text-[42px] md:text-[58px] lg:text-[72px] xl:text-[88px] 2xl:text-[104px] leading-[1.05] font-light whitespace-nowrap ${theme === "dark" ? "dark777-hero-gold-word" : "text-[#111111]"}`}>
                  Profit
                  </span>
                </h1>
              </div>
              ...
              <div className="hero-body max-w-full lg:max-w-[640px] pt-8 sm:pt-12 lg:pt-20">
                <p className={`mb-9 font-playfair text-[17px] md:text-[25px] font-normal leading-relaxed max-w-xl ${theme === "dark" ? "text-[#c8c2ad]" : "text-[#212121]"}`}>
                ...
                <Link
                  href="#discover"
                  className={`inline-flex items-center gap-3 group rounded-full px-5 py-2.5 ${
                    glassVariant === "A"
                      ? "glass-cta-a"
                      : glassVariant === "C"
                        ? "glass-cta-c"
                ...
                >
                  <span className={`font-merriweather text-[15px] md:text-[17px] font-semibold tracking-wide ${theme === "dark" ? "text-[#f3f3f3]" : "text-[#111111]"}`}>
                    Discover more
                  </span>
                  <span
                    className={`relative flex h-9 w-9 items-center justify-center overflow-hidden rounded-full transition-all duration-500 ease-out group-hover:scale-110 ${
                      glassVariant === "A"
                        ? "glass-cta-a-icon"
                        : glassVariant === "C"
                          ? "glass-cta-c-icon"
                      ...
                      glassVariant
                        ...
                        : {
                            background: theme === "dark"
                              ? "linear-gradient(135deg, #e8c97a 0%, #c9a24d 100%)"
                              : lightColors.primary,
                            boxShadow: theme === "dark" ? "0 0 20px rgba(212, 175, 95, 0.35)" : undefined,
                          }
                    }
                  >
      ...
      <section
        ...
        className={`w-full min-h-screen py-0 relative overflow-visible${
          glassVariant === "A"
            ...
            : glassVariant === "C"
              ? " glass-portfolio-section glass-portfolio-section-c"
              : ""
        }`}
        style={{ zIndex: 1 }}
      >
        ...
        {theme === "dark" && sharedBackground && glassVariant === "A" && (
          <div
            className="absolute inset-x-0 bottom-0 h-32 sm:h-40 md:h-48 pointer-events-none z-[1] glass-portfolio-bottom-fade"
            aria-hidden
          />
        )}
        {theme === "dark" && sharedBackground && glassVariant === "C" && (
          <div
            className="absolute inset-x-0 bottom-0 h-32 sm:h-40 md:h-48 pointer-events-none z-[1] glass-portfolio-bottom-fade glass-portfolio-bottom-fade-c"
            aria-hidden
          />
        )}
        <div className="relative z-10 w-full max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 pt-4">
          <header className="text-center mb-12 sm:mb-16">
            ...
            <h2 className={`font-italiana text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight ${theme === "dark" ? "text-white" : "text-[#111111]"}`}>
              ...
              <span className={`relative inline-flex min-w-[6ch] items-center justify-center overflow-hidden rounded-xl px-3 py-1 align-middle text-white -top-[2px] ${
                glassVariant === "A"
                  ? "glass-city-pill"
                  : glassVariant === "C"
                    ? "glass-city-pill-c"
                ...
                <div className="relative flex flex-col w-full" style={{ width: isDesktop ? `${portfolioCardWidth}px` : "85%" }}>
                  ...
                  <div
                    ...
                    className={`relative w-full overflow-hidden rounded-t-xl flex-shrink-0${
                      glassVariant === "A"
                        ? " glass-hero-card-a glass-portfolio-card-a"
                        : glassVariant === "C"
                          ? " glass-hero-card-c glass-portfolio-card-c"
                          : ""
                    }`}
                    style={{
                      aspectRatio: "3 / 4",
