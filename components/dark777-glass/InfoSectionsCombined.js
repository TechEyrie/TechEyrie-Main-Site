            ...
            style={{
              ...
              backgroundImage: `
                conic-gradient(
                  from 0deg at 50% 55%,
                  rgba(212,175,95,0) 0%,
                  rgba(212,175,95,0.38) 18%,
                  rgba(0,81,96,0.30) 42%,
                  rgba(212,175,95,0) 72%,
                  rgba(22,45,36,0) 100%
                ),
                radial-gradient(
                  ellipse at 50% 50%,
          ...
          {orbDefs.map((def, i) => (
            <div
              ...
              style={{
                ...
                transform: "translate(-50%, -50%)",
                backgroundImage:
                  "radial-gradient(circle at center, rgba(212,175,95,0.65) 0%, rgba(0,81,96,0.28) 35%, rgba(22,45,36,0) 72%)",
                opacity: 0.02,
                filter: "blur(18px)",
                boxShadow: "0 0 120px rgba(212,175,95,0.10)",
              }}
            />
          ))}
