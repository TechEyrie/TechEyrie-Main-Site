...
const BlogsSection = ({ theme = "light", sharedBackground = false }) => {
  ...
  const triggerElectricalAnimation = useCallback(() => {
    ...
    const accentOriginalColor = theme === "dark" ? "#d4af37" : "#111111";
  ...
  useEffect(() => {
    ...
    const accentOriginalColor = theme === "dark" ? "#d4af37" : "#111111"; // Accent text
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1500px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="w-full mx-auto mb-10 sm:mb-14 md:mb-16 lg:mb-20 xl:mb-24">
          ...
          <div ref={titleRef} className="mb-6 sm:mb-8 md:mb-10 text-center">
            ...
            >
              ...
              <span className={`new-engen-text block ${theme === "dark" ? "text-[#d4af37]" : "text-[#111111]"}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10 xl:gap-12 mb-10 sm:mb-12 md:mb-14 lg:mb-16">
          ...
          blogPosts.map((post, index) => (
            <Link key={post.id} href={post.slug ? `/blog/${post.slug}` : '/blog'} className="block group">
              ...
              >
                <span
                  className="relative inline-block px-1 bg-transparent group-hover:bg-[#d4af37] transition-all duration-500 ease-out"
                  style={{
                    backgroundImage: `linear-gradient(to right, ${
                      theme === "dark" ? "#d4af37" : "#E8FF6B"
                    } 50%, transparent 50%)`,
        ...
        <div className="flex justify-center">
          <Link
            href="/blog"
            className="dark777-gold-cta group inline-flex items-center justify-center gap-2 rounded-full px-5 py-2.5 sm:px-6 sm:py-3 shadow-sm transition-transform duration-300 ease-out hover:scale-[1.05] hover:-translate-y-[1px]"
          >
