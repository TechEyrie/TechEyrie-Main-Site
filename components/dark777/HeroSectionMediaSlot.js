...
export default function HeroSectionMediaSlot({ theme = "light", sharedBackground = false }) {
  ...
  return (
    ...
    >
      ...
      <section
        ref={heroSectionRef}
        className="relative overflow-visible pt-32 md:pt-40 pb-0 dark777-luxury-hero-section"
        style={{
      ...
      >
        {theme === "dark" && (
          <>
            {/* Radial atmosphere only — no solid fill so gold cubes stay visible */}
            <div
            ...
            <div className="flex flex-col">
              <div className="max-w-full lg:max-w-[1600px] xl:max-w-[1800px]" ref={titleContainerRef}>
                <div className="hero-badge dark777-luxury-badge mb-10 flex items-center gap-3 mb-16">
                  <span
                    className="dark777-luxury-badge-gem inline-flex h-5 w-5 rounded-sm"
                  />
              ...
              <div className="hero-body max-w-full lg:max-w-[640px] pt-8 sm:pt-12 lg:pt-20">
                ...
                <Link href="#discover" className={`dark777-luxury-cta inline-flex items-center gap-3 group rounded-full px-5 py-2.5 ${theme === "dark" ? "" : ""}`}>
