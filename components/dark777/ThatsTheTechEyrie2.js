            ...
            <div className="py-14 sm:py-20">
              ...
              <div className="mt-8 sm:mt-10 space-y-5 max-w-[600px] mx-auto sm:mx-0">
                ...
                <div className="pt-2 flex justify-center sm:justify-start">
                  <Link
                    href="/about"
                    className="dark777-gold-cta group inline-flex items-center justify-center rounded-full px-5 py-2.5 sm:px-6 sm:py-3 shadow-sm transition-transform duration-300 ease-out hover:scale-[1.05] hover:-translate-y-[1px]"
                  >
                ...
                <div className="grid grid-cols-[45%_55%] -mt-40">
                  ...
                  <div className="space-y-6 max-w-[600px]">
                    ...
                    <div className="build-cta pt-2">
                      <Link
                        href="/about"
                        className="dark777-gold-cta group inline-flex items-center justify-center self-start rounded-full px-6 py-3 shadow-sm transition-transform duration-300 ease-out hover:scale-[1.05] hover:-translate-y-[1px] mt-3"
                      >
                        <span className="font-merriweather text-[15px] font-bold tracking-wide">
                          Learn More About Us
                        </span>
                      </Link>
                    </div>
