        ...
        >
          ...
          >
            ...
            <div className="w-full text-center">
              ...
              <p className="font-merriweather text-[10px] sm:text-[13px] font-light leading-[1.2] tracking-[0.04em] text-[#e0d1b6]/75 uppercase">
                {step.description}
              </p>
            </div>
        ...
        >
          {STEPS.map((s, i) => (
            <button
              ...
              className="font-merriweather flex items-center justify-center rounded-full text-[10px] font-medium tracking-[0.03em] transition-all duration-300"
              style={{
                width: 34,
                height: 34,
                background: i === activeStep ? "#74F5A1" : "transparent",
                color: i === activeStep ? "#162d24" : "#e0d1b6",
