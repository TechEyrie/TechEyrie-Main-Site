  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 right-0 top-0 flex items-start justify-between px-5 pt-5">
        <span className="font-merriweather text-[13px] sm:text-[14px] font-light tracking-[0.07em] text-[#f3f3f3]/90 uppercase">
          {project.category}
        </span>
        <span className="font-merriweather text-[13px] sm:text-[14px] font-light tracking-[0.07em] text-[#f3f3f3]/90 uppercase">
      ...
      <div className="absolute bottom-0 left-0 px-5 pb-5">
        <h3 className="font-italiana text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-semibold leading-none tracking-[-0.01em] text-[#f3f3f3]">
          {project.title}
        </h3>
      </div>
