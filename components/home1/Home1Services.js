...
// â”€â”€ Service block â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function ServiceBlock({ service }) {
  ...
  useGSAP(
    () => {
      ...
      // â”€â”€ Category heading â€” kinetic slide-up â”€â”€
      ...
      // â”€â”€ Top line â€” draw left to right â”€â”€
      ...
      itemTextRefs.current.forEach((textEl, i) => {
        ...
        // line â€” draw left to right after text
        if (lineEl) {
  ...
  return (
    <div ref={containerRef}>
      {/* Category label â€” overflow hidden for mask */}
      <div className="mb-5 overflow-hidden pb-[0.08em]">
        <h3
          ref={categoryRef}
          className="font-merriweather text-[26px] sm:text-[30px] md:text-[34px] font-thin tracking-[0.05em] text-[#f3f3f3] uppercase"
      ...
      <div
        ref={topLineRef}
        className="h-[1.5px] w-full bg-[#74F5A1]/35"
      ...
      {service.items.map((item, i) => (
        <div key={item}>
          {/* Item text â€” overflow hidden for mask */}
          <div className="overflow-hidden py-[8px] pb-[calc(8px+0.06em)]">
            <span
              ref={(el) => (itemTextRefs.current[i] = el)}
              className="font-merriweather text-[13px] sm:text-[14px] md:text-[15px] font-thin tracking-[0.06em] text-[#e0d1b6]/75 uppercase"
              style={{
          ...
          {/* Bottom divider line â€” draws left to right */}
          <div
...
export default function Home3Services() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse 90% 70% at 25% 35%, #162d24 0%, #101e27 48%, #050a08 100%)",
        minHeight: "100vh",
      }}
    >
      {/* Blue cursor glow */}
      <div
        ...
        style={{
          background: isHovering
            ? `radial-gradient(ellipse 700px 580px at var(--gx) var(--gy), rgba(116, 245, 161, 0.30) 0%, rgba(103, 191, 218, 0.20) 40%, transparent 70%)`
            : `radial-gradient(ellipse 700px 580px at var(--gx) var(--gy), rgba(116, 245, 161, 0.14) 0%, rgba(103, 191, 218, 0.08) 40%, transparent 70%)`,
          mixBlendMode: "screen",
        }}
      />
      ...
      <div className="relative z-[2] mx-auto max-w-[1200px] px-6 py-20 sm:px-10 md:px-14 lg:px-16">
        ...
        <div ref={headingRef} className="mb-20 md:mb-28">
          <h2 className="font-italiana text-[52px] sm:text-[68px] md:text-[84px] lg:text-[100px] xl:text-[112px] font-thin leading-[0.95] tracking-[-0.02em] text-[#f3f3f3] uppercase">
