...
export default function Home7Gallery() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Large heading */}
        <h2 className="font-ppneue mb-10 text-[42px] sm:text-[56px] md:text-[68px] lg:text-[78px] xl:text-[88px] font-regular leading-[0.92] tracking-[-0.025em] text-[#1a1a1a] uppercase">
        ...
        {/* Subtitle — bottom left, small caps */}
        <p
          ref={subtitleRef}
          className="font-ppneue max-w-[260px] text-[11px] sm:text-[12px] font-light leading-[1.8] tracking-[0.05em] text-[#1a1a1a]/55 uppercase"
        >
