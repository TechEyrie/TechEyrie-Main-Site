...
export default function Home2About() {
  // Left block: 5 lines × 0.18s stagger + 1.1s duration for last line
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px] px-6 sm:px-10">
        ...
        {/* Top-left text block — animates first */}
        <div className="max-w-[600px]">
          <div className="font-ppneue font-thin text-[18px] sm:text-[22px] md:text-[26px] lg:text-[30px] xl:text-[37px] tracking-[-0.01em] text-[#1a1a1a]">
            <AnimatedTextBlock lines={LEFT_LINES} delay={0} />
          </div>
        </div>

        {/* Bottom-right text block — animates after left finishes */}
