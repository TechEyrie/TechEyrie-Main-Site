  ...
  },
  {
    ...
    footer: (
      <p className="text-[14px] sm:text-[15px] font-semibold text-[#111] leading-snug">
        ...
        <br />
        <span className="font-normal text-[#666]">without quality drop-off</span>
      </p>
    ),
  },
];
...
export default function RTSCombinedSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // ── Panel A: card slide (3x2 grid compatible) ──────────────
        ...
        >
          ...
          <div className="max-w-lg">
            <p className="text-[16px] sm:text-[17px] md:text-[18px] font-medium text-[#111] leading-snug mb-4">
              ...
              patented RTS process removes that constraint. Fibers can now
              flow along curves to build lighter, stronger, more efficient parts.
            </p>
