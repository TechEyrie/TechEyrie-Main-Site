...
const CARDS = [
  ...
  {
    id: "speed",
    title: "Production at speed",
    desc: "Automated high-rate manufacturing that scales from prototype to full production.",
    icon: <IconBolt />,
  },
  {
    id: "precision",
    title: "Engineered precision",
    desc: "Fiber placement optimised by software — every layer exactly where it needs to be.",
    icon: <IconTarget />,
  },
  {
    id: "integrated",
    title: "Fully integrated",
    desc: "Design, materials, and production in one unified system — no fragmentation.",
    icon: <IconCog />,
  },
];
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: "clamp(52px, 7vw, 90px)" }}>
        ...
        >
          Unlocking radically more efficient structures.
        </h2>
      </div>
