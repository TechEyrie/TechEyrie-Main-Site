/** ISO 3166-1 alpha-2 + ITU dial codes (all countries and common territories). */
...
export const DEFAULT_COUNTRY =
  COUNTRY_DIAL_CODES.find((c) => c.iso === "QA") ?? COUNTRY_DIAL_CODES[0];
...
export function composePhone(dial, national) {
  const digits = String(national || "").replace(/[^\d\s()-]/g, "").trim();
  if (!digits) return "";
