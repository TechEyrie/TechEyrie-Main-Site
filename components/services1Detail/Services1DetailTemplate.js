...
import "./services1DetailText.css";
...
export default function Services1DetailTemplate({ slug, theme = "light" }) {
  ...
  const cardTheme = isDark
    ? "bg-[#122a21]/80 border border-[#e0d1b6]/15 text-[#e0d1b6]"
    : "bg-white border border-[#d8d3c8] text-[#222]";

  return (
    <main
      ref={rootRef}
      className="services1-detail-root relative overflow-hidden"
    ...
    >
      {isDark && (
        <>
          ...
          <div className="absolute -top-32 -left-24 h-[420px] w-[420px] rounded-full blur-3xl bg-[#74F5A1]/15 pointer-events-none" />
          <div className="absolute top-[42%] -right-24 h-[360px] w-[360px] rounded-full blur-3xl bg-[#005160]/30 pointer-events-none" />
        </>
      )}
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 pt-24 md:pt-32 pb-14 md:pb-16">
        <div className="max-w-[1700px] mx-auto grid lg:grid-cols-[62%_38%] gap-10 items-center">
          <div className="d7-reveal">
            <p className={`font-merriweather uppercase tracking-[0.16em] text-[13px] md:text-[15px] font-semibold mb-7 ${isDark ? "text-[#e0d1b6]" : "text-[#212121]"}`}>Service</p>
            <h1 className={`font-italiana tracking-[-0.03em] leading-[1.02] text-[34px] sm:text-[44px] md:text-[58px] lg:text-[72px] xl:text-[88px] ${isDark ? "text-[#e0d1b6]" : "text-[#111111]"}`}>
              {data.title}
            </h1>
            <h2 className={`font-playfair italic text-[22px] md:text-[30px] leading-[1.35] mt-7 ${isDark ? "s1d-light" : "text-[#013825]"}`}>
              {data.headline}
            </h2>
            <p className={`font-playfair text-[17px] md:text-[24px] leading-relaxed mt-6 max-w-3xl ${isDark ? "text-[#e0d1b6]" : "text-[#212121]"}`}>
              {data.supportingLine}
            </p>
            <Link href="/contact" className="inline-flex items-center gap-3 group mt-8">
              <span className={`font-[Helvetica_Now_Text,Helvetica,Arial,sans-serif] text-[16px] md:text-[20px] font-bold tracking-tight ${isDark ? "text-[#e0d1b6]" : "text-[#111111]"}`}>
                Talk to an Expert
              </span>
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 py-14">
        <div className="max-w-[1700px] mx-auto grid lg:grid-cols-2 gap-6">
          <article className={`d7-reveal rounded-2xl p-7 md:p-9 ${cardTheme}`}>
            ...
            <p className={`font-merriweather text-[15px] md:text-[16px] leading-[1.9] ${isDark ? "s1d-body" : "text-[#3f3a34]"}`}>{data.problemStatement}</p>
          </article>
          <article className={`d7-reveal rounded-2xl p-7 md:p-9 ${cardTheme}`}>
            <h3 className="font-italiana text-[34px] md:text-[48px] leading-tight mb-4">What We Do</h3>
            <p className={`font-merriweather text-[15px] md:text-[16px] leading-[1.9] ${isDark ? "s1d-body" : "text-[#3f3a34]"}`}>{data.whatWeDo}</p>
          </article>
        </div>
      </section>
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 py-16 md:py-20 lg:py-24">
        <div className="max-w-[1700px] mx-auto">
          <div className="d7-reveal mb-10 md:mb-14 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <h3 className={`font-italiana text-[44px] sm:text-[52px] md:text-[72px] lg:text-[84px] leading-[0.98] ${isDark ? "text-[#e0d1b6]" : "text-[#111]"}`}>Key Offerings</h3>
            <span className={`font-merriweather text-[13px] md:text-[15px] lg:text-[16px] uppercase tracking-[0.16em] shrink-0 ${isDark ? "s1d-mint" : "text-[#1f614d]"}`}>
              Built for impact
            </span>
          </div>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-start gap-6 md:gap-8">
                  <div className="relative shrink-0">
                    <div className="inline-flex h-14 w-14 md:h-[4.25rem] md:w-[4.25rem] lg:h-20 lg:w-20 items-center justify-center rounded-2xl bg-[#101e27] border-[3px] border-[#e0d1b6] s1d-light font-extrabold text-xl md:text-2xl lg:text-3xl">
                      {String(idx + 1).padStart(2, "0")}
                    </div>
                    <div className="absolute -inset-1.5 rounded-2xl border border-[#e0d1b6]/25 pointer-events-none" />
                  </div>

                  <p className={`font-merriweather text-[17px] md:text-[19px] lg:text-[21px] leading-[1.75] md:leading-[1.8] ${isDark ? "s1d-body" : "text-[#2d2a26]"}`}>
                    {item}
                  </p>
                </div>
              </article>
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 py-20 md:py-24 lg:py-28 overflow-hidden">
        <div className="max-w-[1700px] mx-auto">
          <div className="d7-reveal mb-12 md:mb-16 flex items-end justify-between gap-4">
            <h3 className={`font-italiana text-[42px] md:text-[72px] lg:text-[86px] leading-[0.95] ${isDark ? "text-[#e0d1b6]" : "text-[#111]"}`}>Our Process</h3>
            <p className={`hidden md:block font-merriweather text-[14px] lg:text-[16px] max-w-[360px] text-right ${isDark ? "s1d-muted" : "text-[#3f3a34]"}`}>
            ...
            <div className="grid md:grid-cols-5 gap-6 lg:gap-8">
              {data.process.map((step) => (
                ...
                >
                  ...
                  <div className="w-[68px] h-[68px] rounded-full bg-[#101e27] border-[3px] border-[#e0d1b6] s1d-light text-[24px] font-extrabold flex items-center justify-center mb-5">
                    {step.step}
                  </div>
                  <p className="font-merriweather text-[12px] tracking-[0.17em] uppercase s1d-mint mb-3">Phase {step.step}</p>
                  <h4 className="font-italiana text-[34px] lg:text-[40px] mb-3 leading-[1.02]">{step.title}</h4>
                  <p className={`font-merriweather text-[15px] lg:text-[16px] leading-[1.85] ${isDark ? "s1d-body" : "text-[#4a453f]"}`}>{step.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="md:hidden relative pl-7">
            ...
            {data.process.map((step) => (
              <div key={step.step} className={`d7-reveal relative rounded-2xl p-5 mb-4 ${cardTheme}`}>
                ...
                <p className="font-merriweather text-xs tracking-[0.16em] uppercase s1d-mint mb-2">Step {step.step}</p>
                <h4 className="font-italiana text-[30px] mb-2 leading-tight">{step.title}</h4>
                <p className={`font-merriweather text-[14px] leading-[1.8] ${isDark ? "s1d-body" : "text-[#4a453f]"}`}>{step.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 py-20 md:py-24 lg:py-28 overflow-hidden">
        ...
        <div className="max-w-[1700px] mx-auto relative">
          <div className="d7-reveal flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 lg:gap-10 mb-10 md:mb-14">
            <div>
              <p className="font-merriweather text-[12px] md:text-[13px] uppercase tracking-[0.18em] s1d-mint mb-4">
                Stack &amp; toolchain
              </p>
              <h3 className={`font-italiana text-[42px] md:text-[72px] lg:text-[86px] leading-[0.95] ${isDark ? "text-[#e0d1b6]" : "text-[#111]"}`}>
                Technologies &amp; Tools
              </h3>
            </div>
            <p className={`font-merriweather text-[15px] md:text-[17px] leading-relaxed max-w-xl lg:text-right ${isDark ? "s1d-muted" : "text-[#3f3a34]"}`}>
                ...
                return (
                  <>
                    <div className="mb-10 md:mb-12">
                      <p className="font-merriweather text-[11px] md:text-[12px] uppercase tracking-[0.2em] s1d-mint mb-4 md:mb-5">
                        Core layer
                      </p>
                      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-5 lg:gap-6">
                        {core.map((tech) => (
                          ...
                          >
                            ...
                            >
                              <Image src={tech.logo} alt={tech.name} width={44} height={44} className="s1d-tech-logo object-contain" unoptimized />
                            </div>
                            <span className={`font-merriweather text-[15px] md:text-[17px] font-semibold ${isDark ? "s1d-light" : "text-[#1a1a1a]"}`}>
                              {tech.name}
                            </span>
                            <span className={`text-[10px] md:text-[11px] uppercase tracking-[0.14em] ${isDark ? "s1d-mint" : "text-[#245241]"}`}>
                              In production
                            </span>
                          </div>
                        ))}
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-5 lg:gap-6">
                          {extended.map((tech) => (
                            ...
                            >
                              ...
                              <span className={`text-[10px] md:text-[11px] uppercase tracking-[0.14em] ${isDark ? "s1d-teal" : "text-[#005160]"}`}>
                                Ships with you
                              </span>
                            </div>
                          ))}
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 py-20 md:py-24">
        <div className="max-w-[1700px] mx-auto">
          <div className="d7-reveal mb-10 md:mb-14 flex flex-col md:flex-row md:items-end md:justify-between gap-5">
            <h3 className={`font-italiana text-[42px] md:text-[72px] lg:text-[84px] leading-[0.95] ${isDark ? "text-[#e0d1b6]" : "text-[#111]"}`}>
              Who We Build For
            </h3>
            <p className={`font-merriweather text-[14px] md:text-[16px] max-w-[520px] md:text-right ${isDark ? "s1d-muted" : "text-[#4a443d]"}`}>
          ...
          <div className="grid lg:grid-cols-[58%_42%] gap-6 md:gap-8">
            <article className={`d7-reveal relative rounded-3xl p-8 md:p-10 lg:p-12 overflow-hidden flex flex-col min-h-0 ${cardTheme}`}>
              ...
              <p className="font-merriweather text-[11px] md:text-[12px] uppercase tracking-[0.2em] s1d-mint mb-4">
                Primary personas
              </p>
              <ul className="space-y-5 md:space-y-6">
                {data.audience.map((item, i) => (
                  <li key={item} className="flex gap-4 md:gap-5 items-start">
                    <span className="mt-1 inline-flex h-8 w-8 md:h-10 md:w-10 shrink-0 rounded-full items-center justify-center border-2 border-[#e0d1b6] s1d-light font-bold text-sm md:text-base">
                      {i + 1}
                    </span>
                    <p className={`font-merriweather text-[16px] md:text-[19px] leading-[1.75] ${isDark ? "s1d-body" : "text-[#332f2a]"}`}>
                      {item}
                    </p>
                  </li>
                ))}
              ...
              <div className="relative z-[1] flex-1 flex flex-col gap-6 md:gap-8">
                  ...
                  <ul className="space-y-3 md:space-y-4">
                    {[
                      ...
                      <li key={line} className="flex gap-3 items-start">
                        <span className="mt-0.5 shrink-0 w-5 h-5 rounded-full bg-[#e0d1b6]/15 border border-[#e0d1b6]/50 flex items-center justify-center s1d-light text-xs font-bold">
                          ✓
                        </span>
                        <span className={`font-merriweather text-[14px] md:text-[16px] leading-[1.7] ${isDark ? "s1d-body" : "text-[#3a3630]"}`}>
                          {line}
                        </span>
                      </li>
                    ))}
                ...
                <div>
                  <p className="font-merriweather text-[11px] md:text-[12px] uppercase tracking-[0.2em] s1d-mint mb-3">
                  ...
                  <div className="flex flex-wrap gap-2 md:gap-3">
                    {["Discovery sprint", "Architecture review", "MVP build", "Scale & hardening", "Ongoing support"].map((tag) => (
                      <span
                        key={tag}
                        className={`font-merriweather text-[12px] md:text-[13px] px-3 py-1.5 rounded-full border ${isDark ? "border-[#e0d1b6]/25 s1d-body bg-[#162d24]/60" : "border-[#245241]/25 text-[#1a2e26] bg-[#f4efe5]"}`}
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className={`rounded-2xl p-4 md:p-5 mt-auto border ${isDark ? "border-[#e0d1b6]/15 bg-[#162d24]/55" : "border-[#d8d1c4] bg-[#faf7f1]"}`}>
                  ...
                  <p className="font-merriweather text-[11px] md:text-[12px] uppercase tracking-[0.14em] s1d-mint mt-3">
            ...
            <article className={`d7-reveal relative rounded-3xl p-8 md:p-10 overflow-hidden ${cardTheme}`}>
              ...
              <p className={`font-merriweather text-[14px] md:text-[15px] mb-6 ${isDark ? "s1d-muted" : "text-[#514b44]"}`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-4">
                {data.stats.map((stat, idx) => (
                  <div key={stat} className={`rounded-2xl p-5 md:p-6 border ${isDark ? "bg-[#162d24]/70 border-[#e0d1b6]/20" : "bg-[#f4efe5] border-[#d8d1c4]"}`}>
                    <p className="font-merriweather text-[30px] md:text-[36px] font-extrabold tracking-tight s1d-mint leading-none">
                      {stat.split(" ").slice(0, 1).join("")}
                    </p>
                    <p className={`font-merriweather text-[12px] md:text-[13px] uppercase tracking-[0.14em] mt-2 ${isDark ? "s1d-muted" : "text-[#5a544c]"}`}>
                      Metric {idx + 1}
                    </p>
                    <p className={`font-merriweather text-[14px] md:text-[15px] mt-2 leading-[1.55] ${isDark ? "s1d-body" : "text-[#3f3a34]"}`}>
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 py-14">
        <div className="max-w-[1700px] mx-auto">
          <div className="d7-reveal mb-8 md:mb-10 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <h3 className={`font-italiana text-[40px] md:text-[64px] leading-[0.95] ${isDark ? "text-[#e0d1b6]" : "text-[#111]"}`}>Case Studies</h3>
            <p className={`font-merriweather text-[14px] md:text-[16px] max-w-[520px] md:text-right ${isDark ? "s1d-muted" : "text-[#4a443d]"}`}>
          ...
          <div className="grid lg:grid-cols-[58%_42%] gap-6 md:gap-8">
            <article className={`d7-reveal relative rounded-3xl overflow-hidden min-h-[360px] md:min-h-[520px] ${cardTheme}`}>
              ...
              <div className="absolute top-5 left-5 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#101e27]/85 border border-[#e0d1b6]/25">
                ...
                <span className="font-merriweather text-[11px] uppercase tracking-[0.14em] s1d-mint">Featured Project</span>
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 lg:p-10">
                <p className="inline-block mb-4 font-merriweather text-[12px] md:text-[13px] uppercase tracking-[0.16em] s1d-mint">
                  {data.caseStudies[0].outcome}
                </p>
                <h4 className="font-italiana text-[34px] md:text-[48px] leading-[1.02] s1d-light mb-3">
                  {data.caseStudies[0].title}
                </h4>
                <p className="font-merriweather text-[14px] md:text-[16px] leading-[1.8] s1d-body max-w-[620px]">
                ...
                <article key={item.title} className={`d7-reveal rounded-2xl overflow-hidden border ${isDark ? "bg-[#162d24]/75 border-[#e0d1b6]/15" : "bg-[#f7f2e8] border-[#d8d1c4]"}`}>
                  <div className="grid sm:grid-cols-[42%_58%] min-h-[220px]">
                    ...
                    <div className="p-5 md:p-6 flex flex-col">
                      <p className="font-merriweather text-[11px] uppercase tracking-[0.14em] s1d-mint mb-3">{item.outcome}</p>
                      <h4 className={`font-italiana text-[28px] leading-[1.02] mb-2 ${isDark ? "s1d-light" : "text-[#1e1a17]"}`}>{item.title}</h4>
                      <p className={`font-merriweather text-[14px] leading-[1.75] ${isDark ? "s1d-body" : "text-[#4f4942]"}`}>{item.summary}</p>
                      <span className="mt-auto pt-4 font-merriweather text-[12px] uppercase tracking-[0.14em] s1d-mint">View breakdown</span>
                    </div>
                  </div>
                </article>
              ))}
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 py-14">
        <div className="max-w-[1700px] mx-auto">
          <h3 className={`d7-reveal font-italiana text-[36px] md:text-[58px] mb-8 ${isDark ? "text-[#e0d1b6]" : "text-[#111]"}`}>FAQ</h3>
              ...
              return (
                <div key={faq.q} className={`d7-reveal rounded-xl overflow-hidden ${cardTheme}`}>
                  <button className="w-full text-left p-5 flex items-center justify-between transition-colors duration-300 hover:bg-white/[0.03]" onClick={() => setOpenFaq(isOpen ? -1 : idx)}>
                    ...
                    <span className={`s1d-mint text-xl transition-transform duration-300 ${isOpen ? "rotate-45" : "rotate-0"}`}>+</span>
                  </button>
                  <div
                  ...
                  >
                    <div ref={(el) => (faqContentRefs.current[idx] = el)}>
                      <p className={`px-5 pb-5 font-merriweather text-[14px] leading-[1.8] ${isDark ? "s1d-body" : "text-[#4a453f]"}`}>{faq.a}</p>
                    </div>
                  </div>
                </div>
              );
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 py-14">
        <div className="max-w-[1700px] mx-auto">
          <h3 className={`d7-reveal font-italiana text-[36px] md:text-[58px] mb-8 ${isDark ? "text-[#e0d1b6]" : "text-[#111]"}`}>Related Services</h3>
            ...
            {data.related.map((service) => (
              <Link key={service.slug} href={`/services1/${service.slug}`} className={`d7-reveal rounded-xl overflow-hidden block transition-transform duration-300 hover:-translate-y-1 ${cardTheme}`}>
                ...
                <div className="p-6 md:p-8 min-h-[120px]">
                  ...
                  <p className={`font-merriweather text-[14px] leading-[1.7] ${isDark ? "s1d-body" : "text-[#4e4942]"}`}>{service.description}</p>
                  <span className="inline-block mt-4 s1d-mint font-merriweather text-sm">View Service -&gt;</span>
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="relative z-10 px-6 md:px-10 lg:px-16 pt-10 pb-20 md:pb-24">
        <div className="services1-detail-cta-box max-w-[1700px] mx-auto d7-reveal rounded-[24px] md:rounded-[30px] p-8 md:p-12 bg-[#12685b] shadow-[0_28px_80px_rgba(18,104,91,0.28)]">
          ...
          <Link href="/contact" className="services1-detail-cta-btn inline-flex mt-7 px-7 py-3 rounded-full bg-[#013825] font-merriweather text-sm md:text-base cursor-pointer transition-colors hover:bg-[#024d33]">
