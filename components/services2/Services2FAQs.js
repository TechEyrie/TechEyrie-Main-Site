...
export default function Services2FAQs({ theme = 'light', dark7 = false }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 mb-12 md:mb-16">
      ...
      {/* FAQs List - Centered */}
      <div className="relative z-[1] max-w-[1400px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
