...
function LuxuryCornerBracket({ className, flip }) {
  ...
  const gradId = `terms-bracket-${uid}`;
  return (
    <svg
      className={className}
      width="72"
...
export default function TermsPageContent() {
  ...
  const triggerElectricalTitle = useCallback(() => {
    ...
    const lines = document.querySelectorAll(".terms-page-title-line");
    ...
    const tl = gsap.timeline({
      onComplete: () => {
        document.querySelectorAll(".terms-page-title-line .char").forEach((c) => {
          c.style.color = "";
          c.style.transform = "";
        });
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.utils.toArray(".terms-section-card").forEach((card) => {
        gsap.from(card, {
          immediateRender: false,
          scrollTrigger: {
            trigger: card,
      ...
      gsap.from(".terms-toc-reveal", {
        immediateRender: false,
        scrollTrigger: {
          trigger: ".terms-toc-panel",
          start: "top 85%",
          toggleActions: "play none none none",
        },
        x: -28,
      ...
      gsap.from(".terms-mobile-toc-reveal", {
        immediateRender: false,
        scrollTrigger: {
          trigger: ".terms-mobile-toc-reveal",
          start: "top 92%",
          toggleActions: "play none none none",
        },
        y: 20,
      ...
      gsap.from(".terms-cta-block", {
        immediateRender: false,
        scrollTrigger: {
          trigger: ".terms-cta-block",
          start: "top 88%",
          toggleActions: "play none none none",
        },
        y: 40,
  ...
  useEffect(() => {
    const nodes = TERMS_SECTIONS.map((s) => document.getElementById(s.id)).filter(Boolean);
  ...
  const TocButton = ({ section, compact }) => {
    ...
    return (
      <button
        ...
        className={`terms-toc-btn group flex w-full items-center gap-3 rounded-xl border text-left transition-all duration-300 ${
          isActive ? "terms-toc-btn-active" : ""
    ...
    <div className="relative overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          <div className="terms-hero-reveal mb-7 flex flex-wrap items-center gap-x-5 gap-y-3 sm:gap-x-7">
            <span className="inline-flex h-[2px] w-10 shrink-0 bg-gradient-to-r from-[#a7b431] to-[#74F5A1] sm:w-14" />
            <div className="flex items-center gap-3 sm:gap-4">
              <Scale className="h-4 w-4 shrink-0 sm:h-5 sm:w-5" color="#74F5A1" strokeWidth={1.5} />
          ...
          <h1
            ref={titleRef}
            className="terms-page-heading max-w-5xl font-italiana font-light leading-[1.05] tracking-[0.012em] text-[#f3f3f3]"
          >
            <span className="terms-page-title-line block text-[34px] sm:text-[44px] md:text-[54px] lg:text-[64px] xl:text-[76px] 2xl:text-[86px]">
              Terms, framed with
            </span>
            <span className="terms-page-title-line block font-playfair font-semibold italic text-[34px] sm:text-[44px] md:text-[54px] lg:text-[64px] xl:text-[76px] 2xl:text-[86px] text-[#e8e4dc]">
              elegance & edge
            </span>
          </h1>
      ...
      >
        ...
        <div ref={contentRef} className="relative z-10 mx-auto max-w-[1600px] px-4 sm:px-6 md:px-8 lg:px-10">
          <div
            ref={bridgeRef}
            className="mx-auto mb-10 flex max-w-2xl flex-col items-center text-center lg:mb-14 lg:max-w-6xl xl:max-w-7xl"
          >
            <div className="terms-bridge-reveal mb-6 flex w-full max-w-sm items-center gap-3 sm:max-w-md">
            ...
            <p className="terms-bridge-reveal font-italiana text-[26px] text-[#e0d1b6] sm:text-[30px] md:text-[36px]">
              Terms at a glance
            </p>
            <p className="terms-bridge-reveal mt-2 font-merriweather text-[11px] sm:text-[12px] md:text-[13px] font-regular uppercase tracking-[0.16em] text-[#a0a0a0]">
              Jump to any section
            </p>
          </div>

          <div className="terms-mobile-toc-reveal mb-10 flex gap-2 overflow-x-auto pb-2 lg:hidden [-webkit-overflow-scrolling:touch]">
          ...
          <div className="flex flex-col gap-12 lg:flex-row lg:gap-14 xl:gap-20">
            <aside className="terms-toc-reveal hidden lg:block lg:w-80 xl:w-[22rem] lg:flex-shrink-0">
              <div className="terms-toc-panel sticky top-28 rounded-2xl border border-white/[0.11] bg-[rgba(12,22,18,0.55)] p-6 backdrop-blur-xl shadow-[0_28px_64px_-20px_rgba(0,0,0,0.5)] xl:p-7">
            ...
            <div className="min-w-0 flex-1">
              {TERMS_SECTIONS.map((section) => {
                ...
                return (
                  <section
                    key={section.id}
                    id={section.id}
                    className="terms-section-card faqs-lux-card relative mb-8 scroll-mt-28 overflow-hidden rounded-2xl border border-white/[0.11] bg-[rgba(12,22,18,0.45)] backdrop-blur-xl transition-all duration-500 last:mb-0 hover:border-[#a7b431]/22 sm:mb-10"
                  >
              ...
              <div className="terms-cta-block faqs-lux-cta-panel relative mt-14 overflow-hidden rounded-[28px] border border-white/[0.1] px-7 py-12 text-center sm:mt-20 sm:px-10 sm:py-14 md:px-14 md:py-20">
                <div
                ...
                <p className="mx-auto mt-4 max-w-md font-playfair text-[14px] italic leading-relaxed text-[#b5ae9c] sm:text-[15px]">
                  We&apos;re happy to clarify scope, engagement mechanics, or jurisdiction—
                  just ask.
                </p>
                <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-5">
                  <a
                    href="mailto:hello@dapper.agency"
                    className="terms-cta-link inline-flex items-center justify-center gap-2 rounded-full px-8 py-3.5 shadow-[0_12px_40px_-8px_rgba(18,104,91,0.55)] transition-all duration-300 ease-out hover:scale-[1.05] hover:-translate-y-0.5 hover:shadow-[0_16px_48px_-8px_rgba(18,104,91,0.65)]"
